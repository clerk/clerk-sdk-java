 ...
 *
 */
@JsonDeserialize(using = OauthVerificationStatus._Deserializer.class)
@JsonSerialize(using = OauthVerificationStatus._Serializer.class)
public class OauthVerificationStatus {
    ...
    // convention)
    private static final Map<String, OauthVerificationStatus> values = createValuesMap();
    private static final Map<String, OauthVerificationStatusEnum> enums = createEnumsMap();
    ...
    /**
     * Returns a OauthVerificationStatus with the given value. For a specific value the 
     * returned object will always be a singleton so reference equality 
     * is satisfied when the values are the same.
     * 
     * @param value value to be wrapped as OauthVerificationStatus
     */ 
    public static OauthVerificationStatus of(String value) {
        synchronized (OauthVerificationStatus.class) {
            return values.computeIfAbsent(value, v -> new OauthVerificationStatus(v));
        }
    }
    ...
    public String toString() {
        return "OauthVerificationStatus [value=" + value + "]";
    }

    // return an array just like an enum
    public static OauthVerificationStatus[] values() {
        synchronized (OauthVerificationStatus.class) {
            return values.values().toArray(new OauthVerificationStatus[] {});
        }
    }

    private static final Map<String, OauthVerificationStatus> createValuesMap() {
        Map<String, OauthVerificationStatus> map = new LinkedHashMap<>();
    ...
    private static final Map<String, OauthVerificationStatusEnum> createEnumsMap() {
        Map<String, OauthVerificationStatusEnum> map = new HashMap<>();
    ...
    public static final class _Serializer extends StdSerializer<OauthVerificationStatus> {
        ...
        @Override
        public void serialize(OauthVerificationStatus value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<OauthVerificationStatus> {
        ...
        @Override
        public OauthVerificationStatus deserialize(JsonParser p, DeserializationContext ctxt)
    ...
    public enum OauthVerificationStatusEnum {
