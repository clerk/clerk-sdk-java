...
public class SAMLConnection {
    ...
    public static SAMLConnection of(One value) {
        Utils.checkNotNull(value, "value");
        return new SAMLConnection(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }

    public static SAMLConnection of(Two value) {
        Utils.checkNotNull(value, "value");
        return new SAMLConnection(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <ul>
     * <li>{@code com.clerk.backend_api.models.components.One}</li>
     * <li>{@code com.clerk.backend_api.models.components.Two}</li>
     * </ul>
     * 
