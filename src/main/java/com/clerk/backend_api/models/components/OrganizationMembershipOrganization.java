...
public class OrganizationMembershipOrganization {
    ...
    public OrganizationMembershipOrganization withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
    ...
    public OrganizationMembershipOrganization withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }

    public OrganizationMembershipOrganization withHasImage(boolean hasImage) {
        Utils.checkNotNull(hasImage, "hasImage");
        this.hasImage = hasImage;
        return this;
    }
     ...
     * Whether this organization can configure self-serve enterprise SSO.
     */
    public OrganizationMembershipOrganization withSelfServeSsoEnabled(boolean selfServeSsoEnabled) {
        Utils.checkNotNull(selfServeSsoEnabled, "selfServeSsoEnabled");
     ...
     * Whether this organization can configure self-serve enterprise SSO.
     */
    public OrganizationMembershipOrganization withSelfServeSsoEnabled(JsonNullable<Boolean> selfServeSsoEnabled) {
        Utils.checkNotNull(selfServeSsoEnabled, "selfServeSsoEnabled");
        this.selfServeSsoEnabled = selfServeSsoEnabled;
        return this;
    }
    ...
    public OrganizationMembershipOrganization withPrivateMetadata(Optional<? extends Map<String, Object>> privateMetadata) {
        Utils.checkNotNull(privateMetadata, "privateMetadata");
        this.privateMetadata = privateMetadata;
        return this;
    }
     ...
     * Unix timestamp of last activity.
     */
    public OrganizationMembershipOrganization withLastActiveAt(long lastActiveAt) {
        Utils.checkNotNull(lastActiveAt, "lastActiveAt");
     ...
     * Unix timestamp of last activity.
     */
    public OrganizationMembershipOrganization withLastActiveAt(Optional<Long> lastActiveAt) {
        Utils.checkNotNull(lastActiveAt, "lastActiveAt");
        this.lastActiveAt = lastActiveAt;
        return this;
    }
