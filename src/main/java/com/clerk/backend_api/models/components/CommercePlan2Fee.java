...
public class CommercePlan2Fee {
     ...
     * The amount in cents.
     */
    public CommercePlan2Fee withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public CommercePlan2Fee withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public CommercePlan2Fee withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public CommercePlan2Fee withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CommercePlan2Fee other = (CommercePlan2Fee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CommercePlan2Fee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public CommercePlan2Fee build() {

            return new CommercePlan2Fee(
                amount, amountFormatted, currency,
                currencySymbol);
        }
