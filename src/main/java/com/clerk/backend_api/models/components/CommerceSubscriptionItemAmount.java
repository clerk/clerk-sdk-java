...
public class CommerceSubscriptionItemAmount {
    ...
    @JsonCreator
    public CommerceSubscriptionItemAmount(
     ...
     * The amount in cents.
     */
    public CommerceSubscriptionItemAmount withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public CommerceSubscriptionItemAmount withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public CommerceSubscriptionItemAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public CommerceSubscriptionItemAmount withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CommerceSubscriptionItemAmount other = (CommerceSubscriptionItemAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CommerceSubscriptionItemAmount.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public CommerceSubscriptionItemAmount build() {

            return new CommerceSubscriptionItemAmount(
                amount, amountFormatted, currency,
                currencySymbol);
        }
