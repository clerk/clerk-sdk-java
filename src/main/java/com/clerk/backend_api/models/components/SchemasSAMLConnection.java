...
@JsonDeserialize(using = SchemasSAMLConnection._Deserializer.class)
public class SchemasSAMLConnection {
    ...
    public static final class _Deserializer extends OneOfDeserializer<SchemasSAMLConnection> {
