...
public class VerificationOauthVerificationOauth implements ExternalAccountWithVerificationVerification {
    ...
    @JsonCreator
    public VerificationOauthVerificationOauth(
    ...
    public VerificationOauthVerificationOauth withObject(VerificationOauthVerificationObject object) {
        Utils.checkNotNull(object, "object");
    ...
    public VerificationOauthVerificationOauth withObject(Optional<? extends VerificationOauthVerificationObject> object) {
        Utils.checkNotNull(object, "object");
        this.object = object;
        return this;
    }

    public VerificationOauthVerificationOauth withStatus(VerificationOauthVerificationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public VerificationOauthVerificationOauth withStrategy(String strategy) {
        Utils.checkNotNull(strategy, "strategy");
        this.strategy = strategy;
        return this;
    }

    public VerificationOauthVerificationOauth withExternalVerificationRedirectUrl(String externalVerificationRedirectUrl) {
        Utils.checkNotNull(externalVerificationRedirectUrl, "externalVerificationRedirectUrl");
    ...
    public VerificationOauthVerificationOauth withExternalVerificationRedirectUrl(Optional<String> externalVerificationRedirectUrl) {
        Utils.checkNotNull(externalVerificationRedirectUrl, "externalVerificationRedirectUrl");
        this.externalVerificationRedirectUrl = externalVerificationRedirectUrl;
        return this;
    }

    public VerificationOauthVerificationOauth withError(VerificationOauthVerificationError error) {
        Utils.checkNotNull(error, "error");
        this.error = JsonNullable.of(error);
        return this;
    }

    public VerificationOauthVerificationOauth withError(JsonNullable<? extends VerificationOauthVerificationError> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }

    public VerificationOauthVerificationOauth withExpireAt(long expireAt) {
        Utils.checkNotNull(expireAt, "expireAt");
        this.expireAt = expireAt;
        return this;
    }

    public VerificationOauthVerificationOauth withAttempts(long attempts) {
        Utils.checkNotNull(attempts, "attempts");
    ...
    public VerificationOauthVerificationOauth withAttempts(Optional<Long> attempts) {
        Utils.checkNotNull(attempts, "attempts");
        this.attempts = attempts;
        return this;
    }

    public VerificationOauthVerificationOauth withVerifiedAtClient(String verifiedAtClient) {
        Utils.checkNotNull(verifiedAtClient, "verifiedAtClient");
        this.verifiedAtClient = JsonNullable.of(verifiedAtClient);
        return this;
    }

    public VerificationOauthVerificationOauth withVerifiedAtClient(JsonNullable<String> verifiedAtClient) {
        Utils.checkNotNull(verifiedAtClient, "verifiedAtClient");
        this.verifiedAtClient = verifiedAtClient;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VerificationOauthVerificationOauth other = (VerificationOauthVerificationOauth) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VerificationOauthVerificationOauth.class,
                "object", object,
                "status", status,
                "strategy", strategy,
    ...
    public final static class Builder {
        ...
        public VerificationOauthVerificationOauth build() {

            return new VerificationOauthVerificationOauth(
                object, status, strategy,
                externalVerificationRedirectUrl, error, expireAt,
                attempts, verifiedAtClient);
        }
