...
public class Credit {
    ...
    @JsonProperty("amount")
    private JsonNullable<? extends CommerceSubscriptionItem2CreditAmount> amount;
    ...
    @JsonCreator
    public Credit(
            @JsonProperty("amount") JsonNullable<? extends CommerceSubscriptionItem2CreditAmount> amount,
    ...
    @JsonIgnore
    public JsonNullable<CommerceSubscriptionItem2CreditAmount> amount() {
        return (JsonNullable<CommerceSubscriptionItem2CreditAmount>) amount;
    }
     ...
     * Credit amount.
     */
    public Credit withAmount(CommerceSubscriptionItem2CreditAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * Credit amount.
     */
    public Credit withAmount(JsonNullable<? extends CommerceSubscriptionItem2CreditAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends CommerceSubscriptionItem2CreditAmount> amount = JsonNullable.undefined();
         ...
         * Credit amount.
         */
        public Builder amount(CommerceSubscriptionItem2CreditAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = JsonNullable.of(amount);
            return this;
        }
         ...
         * Credit amount.
         */
        public Builder amount(JsonNullable<? extends CommerceSubscriptionItem2CreditAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
