...
public class SAMLAccountConnection1 {
    ...
    public SAMLAccountConnection1(
            ...
            long updatedAt) {
        this(id, name, domain,
            Optional.empty(), active, provider,
    ...
    public SAMLAccountConnection1 withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public SAMLAccountConnection1 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     */
    @Deprecated
    public SAMLAccountConnection1 withDomain(String domain) {
        Utils.checkNotNull(domain, "domain");
        this.domain = domain;
        return this;
    }

    public SAMLAccountConnection1 withDomains(List<String> domains) {
        Utils.checkNotNull(domains, "domains");
    ...
    public SAMLAccountConnection1 withDomains(Optional<? extends List<String>> domains) {
        Utils.checkNotNull(domains, "domains");
        this.domains = domains;
        return this;
    }

    public SAMLAccountConnection1 withActive(boolean active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }

    public SAMLAccountConnection1 withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }

    public SAMLAccountConnection1 withSyncUserAttributes(boolean syncUserAttributes) {
        Utils.checkNotNull(syncUserAttributes, "syncUserAttributes");
        this.syncUserAttributes = syncUserAttributes;
        return this;
    }

    public SAMLAccountConnection1 withAllowSubdomains(boolean allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
    ...
    public SAMLAccountConnection1 withAllowSubdomains(Optional<Boolean> allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
        this.allowSubdomains = allowSubdomains;
        return this;
    }

    public SAMLAccountConnection1 withAllowIdpInitiated(boolean allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
    ...
    public SAMLAccountConnection1 withAllowIdpInitiated(Optional<Boolean> allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
        this.allowIdpInitiated = allowIdpInitiated;
        return this;
    }

    public SAMLAccountConnection1 withDisableAdditionalIdentifications(boolean disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
    ...
    public SAMLAccountConnection1 withDisableAdditionalIdentifications(Optional<Boolean> disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
        this.disableAdditionalIdentifications = disableAdditionalIdentifications;
        return this;
    }
     ...
     * Unix timestamp of creation.
     */
    public SAMLAccountConnection1 withCreatedAt(long createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Unix timestamp of last update.
     */
    public SAMLAccountConnection1 withUpdatedAt(long updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SAMLAccountConnection1 other = (SAMLAccountConnection1) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SAMLAccountConnection1.class,
                "id", id,
                "name", name,
                "domain", domain,
                "domains", domains,
    ...
    public final static class Builder {
        ...
        public SAMLAccountConnection1 build() {

            return new SAMLAccountConnection1(
                id, name, domain,
                domains, active, provider,
                syncUserAttributes, allowSubdomains, allowIdpInitiated,
                disableAdditionalIdentifications, createdAt, updatedAt);
