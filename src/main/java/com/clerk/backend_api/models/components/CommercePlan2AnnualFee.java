...
public class CommercePlan2AnnualFee {
     ...
     * The amount in cents.
     */
    public CommercePlan2AnnualFee withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public CommercePlan2AnnualFee withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public CommercePlan2AnnualFee withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public CommercePlan2AnnualFee withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CommercePlan2AnnualFee other = (CommercePlan2AnnualFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CommercePlan2AnnualFee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public CommercePlan2AnnualFee build() {

            return new CommercePlan2AnnualFee(
                amount, amountFormatted, currency,
                currencySymbol);
        }
