...
public class VerificationSamlErrorClerkError {
    ...
    public VerificationSamlErrorClerkError withMeta(Map<String, Object> meta) {
        Utils.checkNotNull(meta, "meta");
    ...
    public VerificationSamlErrorClerkError withMeta(Optional<? extends Map<String, Object>> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
