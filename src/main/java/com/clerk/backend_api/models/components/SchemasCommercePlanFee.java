...
public class SchemasCommercePlanFee {
     ...
     * The amount in cents.
     */
    public SchemasCommercePlanFee withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public SchemasCommercePlanFee withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public SchemasCommercePlanFee withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public SchemasCommercePlanFee withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SchemasCommercePlanFee other = (SchemasCommercePlanFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SchemasCommercePlanFee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public SchemasCommercePlanFee build() {

            return new SchemasCommercePlanFee(
                amount, amountFormatted, currency,
                currencySymbol);
        }
