...
public class EnterpriseConnection1 {
    ...
    public EnterpriseConnection1 withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public EnterpriseConnection1 withProtocol(String protocol) {
        Utils.checkNotNull(protocol, "protocol");
        this.protocol = protocol;
        return this;
    }

    public EnterpriseConnection1 withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }

    public EnterpriseConnection1 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public EnterpriseConnection1 withLogoPublicUrl(String logoPublicUrl) {
        Utils.checkNotNull(logoPublicUrl, "logoPublicUrl");
    ...
    public EnterpriseConnection1 withLogoPublicUrl(Optional<String> logoPublicUrl) {
        Utils.checkNotNull(logoPublicUrl, "logoPublicUrl");
        this.logoPublicUrl = logoPublicUrl;
        return this;
    }
     ...
     */
    @Deprecated
    public EnterpriseConnection1 withDomain(String domain) {
        Utils.checkNotNull(domain, "domain");
        this.domain = domain;
        return this;
    }

    public EnterpriseConnection1 withDomains(List<String> domains) {
        Utils.checkNotNull(domains, "domains");
    ...
    public EnterpriseConnection1 withDomains(Optional<? extends List<String>> domains) {
        Utils.checkNotNull(domains, "domains");
        this.domains = domains;
        return this;
    }

    public EnterpriseConnection1 withActive(boolean active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }

    public EnterpriseConnection1 withSyncUserAttributes(boolean syncUserAttributes) {
        Utils.checkNotNull(syncUserAttributes, "syncUserAttributes");
        this.syncUserAttributes = syncUserAttributes;
        return this;
    }

    public EnterpriseConnection1 withAllowSubdomains(boolean allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
        this.allowSubdomains = allowSubdomains;
        return this;
    }

    public EnterpriseConnection1 withAllowIdpInitiated(boolean allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
        this.allowIdpInitiated = allowIdpInitiated;
        return this;
    }

    public EnterpriseConnection1 withDisableAdditionalIdentifications(boolean disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
        this.disableAdditionalIdentifications = disableAdditionalIdentifications;
        return this;
    }
     ...
     * Unix timestamp of creation.
     */
    public EnterpriseConnection1 withCreatedAt(long createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Unix timestamp of last update.
     */
    public EnterpriseConnection1 withUpdatedAt(long updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EnterpriseConnection1 other = (EnterpriseConnection1) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EnterpriseConnection1.class,
                "id", id,
                "protocol", protocol,
                "provider", provider,
                "name", name,
    ...
    public final static class Builder {
        ...
        public EnterpriseConnection1 build() {

            return new EnterpriseConnection1(
                id, protocol, provider,
                name, logoPublicUrl, domain,
                domains, active, syncUserAttributes,
                allowSubdomains, allowIdpInitiated, disableAdditionalIdentifications,
