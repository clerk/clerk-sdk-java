...
public class AnnualFee {
     ...
     * The amount in cents.
     */
    public AnnualFee withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public AnnualFee withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public AnnualFee withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public AnnualFee withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AnnualFee.class,
                "amount", amount,
