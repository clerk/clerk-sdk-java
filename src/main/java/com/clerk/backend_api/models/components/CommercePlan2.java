...
public class CommercePlan2 {
     ...
     */
    @JsonProperty("object")
    private CommercePlan2Object object;
    ...
    @JsonProperty("fee")
    private Optional<? extends CommercePlan2Fee> fee;


    @JsonInclude(Include.ALWAYS)
    @JsonProperty("annual_monthly_fee")
    private Optional<? extends CommercePlan2AnnualMonthlyFee> annualMonthlyFee;


    @JsonInclude(Include.ALWAYS)
    @JsonProperty("annual_fee")
    private Optional<? extends CommercePlan2AnnualFee> annualFee;
    ...
    @JsonCreator
    public CommercePlan2(
            @JsonProperty("object") CommercePlan2Object object,
            @JsonProperty("id") String id,
            @JsonProperty("name") String name,
            @JsonProperty("fee") Optional<? extends CommercePlan2Fee> fee,
            @JsonProperty("annual_monthly_fee") Optional<? extends CommercePlan2AnnualMonthlyFee> annualMonthlyFee,
            @JsonProperty("annual_fee") Optional<? extends CommercePlan2AnnualFee> annualFee,
     ...
     */
    @JsonIgnore
    public CommercePlan2Object object() {
        return object;
    }
    ...
    @JsonIgnore
    public Optional<CommercePlan2Fee> fee() {
        return (Optional<CommercePlan2Fee>) fee;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CommercePlan2AnnualMonthlyFee> annualMonthlyFee() {
        return (Optional<CommercePlan2AnnualMonthlyFee>) annualMonthlyFee;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CommercePlan2AnnualFee> annualFee() {
        return (Optional<CommercePlan2AnnualFee>) annualFee;
    }
     ...
     * String representing the object's type. Objects of the same type share the same value.
     */
    public CommercePlan2 withObject(CommercePlan2Object object) {
        Utils.checkNotNull(object, "object");
        this.object = object;
        return this;
    }
     ...
     * Unique identifier for the commerce plan.
     */
    public CommercePlan2 withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The name of the commerce plan.
     */
    public CommercePlan2 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public CommercePlan2 withFee(CommercePlan2Fee fee) {
        Utils.checkNotNull(fee, "fee");
    ...
    public CommercePlan2 withFee(Optional<? extends CommercePlan2Fee> fee) {
        Utils.checkNotNull(fee, "fee");
        this.fee = fee;
        return this;
    }

    public CommercePlan2 withAnnualMonthlyFee(CommercePlan2AnnualMonthlyFee annualMonthlyFee) {
        Utils.checkNotNull(annualMonthlyFee, "annualMonthlyFee");
    ...
    public CommercePlan2 withAnnualMonthlyFee(Optional<? extends CommercePlan2AnnualMonthlyFee> annualMonthlyFee) {
        Utils.checkNotNull(annualMonthlyFee, "annualMonthlyFee");
        this.annualMonthlyFee = annualMonthlyFee;
        return this;
    }

    public CommercePlan2 withAnnualFee(CommercePlan2AnnualFee annualFee) {
        Utils.checkNotNull(annualFee, "annualFee");
    ...
    public CommercePlan2 withAnnualFee(Optional<? extends CommercePlan2AnnualFee> annualFee) {
        Utils.checkNotNull(annualFee, "annualFee");
        this.annualFee = annualFee;
        return this;
    }
     ...
     * The amount in cents for the plan.
     */
    public CommercePlan2 withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public CommercePlan2 withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The monthly amount in cents when billed annually.
     */
    public CommercePlan2 withAnnualMonthlyAmount(long annualMonthlyAmount) {
        Utils.checkNotNull(annualMonthlyAmount, "annualMonthlyAmount");
        this.annualMonthlyAmount = annualMonthlyAmount;
        return this;
    }
     ...
     * The formatted annual monthly amount as a string.
     */
    public CommercePlan2 withAnnualMonthlyAmountFormatted(String annualMonthlyAmountFormatted) {
        Utils.checkNotNull(annualMonthlyAmountFormatted, "annualMonthlyAmountFormatted");
        this.annualMonthlyAmountFormatted = annualMonthlyAmountFormatted;
        return this;
    }
     ...
     * The total annual amount in cents.
     */
    public CommercePlan2 withAnnualAmount(long annualAmount) {
        Utils.checkNotNull(annualAmount, "annualAmount");
        this.annualAmount = annualAmount;
        return this;
    }
     ...
     * The formatted annual amount as a string.
     */
    public CommercePlan2 withAnnualAmountFormatted(String annualAmountFormatted) {
        Utils.checkNotNull(annualAmountFormatted, "annualAmountFormatted");
        this.annualAmountFormatted = annualAmountFormatted;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public CommercePlan2 withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public CommercePlan2 withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The description of the commerce plan.
     */
    public CommercePlan2 withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The ID of the product this plan belongs to.
     */
    public CommercePlan2 withProductId(String productId) {
        Utils.checkNotNull(productId, "productId");
        this.productId = productId;
        return this;
    }
     ...
     * Whether this is the default plan.
     */
    public CommercePlan2 withIsDefault(boolean isDefault) {
        Utils.checkNotNull(isDefault, "isDefault");
        this.isDefault = isDefault;
        return this;
    }
     ...
     * Whether this is a recurring plan.
     */
    public CommercePlan2 withIsRecurring(boolean isRecurring) {
        Utils.checkNotNull(isRecurring, "isRecurring");
        this.isRecurring = isRecurring;
        return this;
    }
     ...
     * Whether this plan is publicly visible.
     */
    public CommercePlan2 withPubliclyVisible(boolean publiclyVisible) {
        Utils.checkNotNull(publiclyVisible, "publiclyVisible");
        this.publiclyVisible = publiclyVisible;
        return this;
    }
     ...
     * Whether this plan has a base fee.
     */
    public CommercePlan2 withHasBaseFee(boolean hasBaseFee) {
        Utils.checkNotNull(hasBaseFee, "hasBaseFee");
        this.hasBaseFee = hasBaseFee;
        return this;
    }
     ...
     * The types of payers that can use this plan.
     */
    public CommercePlan2 withPayerType(List<String> payerType) {
        Utils.checkNotNull(payerType, "payerType");
        this.payerType = payerType;
        return this;
    }
     ...
     * The payer type this plan is designed for.
     */
    public CommercePlan2 withForPayerType(String forPayerType) {
        Utils.checkNotNull(forPayerType, "forPayerType");
        this.forPayerType = forPayerType;
        return this;
    }
     ...
     * The URL-friendly slug for the plan.
     */
    public CommercePlan2 withSlug(String slug) {
        Utils.checkNotNull(slug, "slug");
        this.slug = slug;
        return this;
    }
     ...
     * The URL of the plan's avatar image.
     */
    public CommercePlan2 withAvatarUrl(String avatarUrl) {
        Utils.checkNotNull(avatarUrl, "avatarUrl");
        this.avatarUrl = avatarUrl;
        return this;
    }
     ...
     * The billing period for the plan.
     */
    public CommercePlan2 withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * The billing period for the plan.
     */
    public CommercePlan2 withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * The billing interval.
     */
    public CommercePlan2 withInterval(long interval) {
        Utils.checkNotNull(interval, "interval");
     ...
     * The billing interval.
     */
    public CommercePlan2 withInterval(Optional<Long> interval) {
        Utils.checkNotNull(interval, "interval");
        this.interval = interval;
        return this;
    }
     ...
     * The features included in this plan.
     */
    public CommercePlan2 withFeatures(List<FeatureResponse2> features) {
        Utils.checkNotNull(features, "features");
        this.features = features;
        return this;
    }
     ...
     * Whether free trial is enabled for this plan.
     */
    public CommercePlan2 withFreeTrialEnabled(boolean freeTrialEnabled) {
        Utils.checkNotNull(freeTrialEnabled, "freeTrialEnabled");
     ...
     * Whether free trial is enabled for this plan.
     */
    public CommercePlan2 withFreeTrialEnabled(Optional<Boolean> freeTrialEnabled) {
        Utils.checkNotNull(freeTrialEnabled, "freeTrialEnabled");
        this.freeTrialEnabled = freeTrialEnabled;
        return this;
    }
     ...
     * Number of free trial days for this plan.
     */
    public CommercePlan2 withFreeTrialDays(long freeTrialDays) {
        Utils.checkNotNull(freeTrialDays, "freeTrialDays");
     ...
     * Number of free trial days for this plan.
     */
    public CommercePlan2 withFreeTrialDays(JsonNullable<Long> freeTrialDays) {
        Utils.checkNotNull(freeTrialDays, "freeTrialDays");
        this.freeTrialDays = freeTrialDays;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CommercePlan2 other = (CommercePlan2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CommercePlan2.class,
                "object", object,
                "id", id,
                "name", name,
                "fee", fee,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CommercePlan2Fee> fee = Optional.empty();

        private Optional<? extends CommercePlan2AnnualMonthlyFee> annualMonthlyFee = Optional.empty();

        private Optional<? extends CommercePlan2AnnualFee> annualFee = Optional.empty();
         ...
         * String representing the object's type. Objects of the same type share the same value.
         */
        public Builder object(CommercePlan2Object object) {
            Utils.checkNotNull(object, "object");
            this.object = object;
            return this;
        }
        ...
        public Builder fee(CommercePlan2Fee fee) {
            Utils.checkNotNull(fee, "fee");
            this.fee = Optional.ofNullable(fee);
            return this;
        }

        public Builder fee(Optional<? extends CommercePlan2Fee> fee) {
            Utils.checkNotNull(fee, "fee");
            this.fee = fee;
            return this;
        }
        ...
        public Builder annualMonthlyFee(CommercePlan2AnnualMonthlyFee annualMonthlyFee) {
            Utils.checkNotNull(annualMonthlyFee, "annualMonthlyFee");
            this.annualMonthlyFee = Optional.ofNullable(annualMonthlyFee);
            return this;
        }

        public Builder annualMonthlyFee(Optional<? extends CommercePlan2AnnualMonthlyFee> annualMonthlyFee) {
            Utils.checkNotNull(annualMonthlyFee, "annualMonthlyFee");
            this.annualMonthlyFee = annualMonthlyFee;
            return this;
        }
        ...
        public Builder annualFee(CommercePlan2AnnualFee annualFee) {
            Utils.checkNotNull(annualFee, "annualFee");
            this.annualFee = Optional.ofNullable(annualFee);
            return this;
        }

        public Builder annualFee(Optional<? extends CommercePlan2AnnualFee> annualFee) {
            Utils.checkNotNull(annualFee, "annualFee");
            this.annualFee = annualFee;
            return this;
        }
        ...
        public CommercePlan2 build() {

            return new CommercePlan2(
                object, id, name,
                fee, annualMonthlyFee, annualFee,
                amount, amountFormatted, annualMonthlyAmount,
                annualMonthlyAmountFormatted, annualAmount, annualAmountFormatted,
