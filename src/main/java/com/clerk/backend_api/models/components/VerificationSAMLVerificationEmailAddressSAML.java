...
public class VerificationSAMLVerificationEmailAddressSAML implements Verification {
    ...
    @JsonCreator
    public VerificationSAMLVerificationEmailAddressSAML(
    ...
    public VerificationSAMLVerificationEmailAddressSAML withObject(VerificationSamlVerificationObject object) {
        Utils.checkNotNull(object, "object");
    ...
    public VerificationSAMLVerificationEmailAddressSAML withObject(Optional<? extends VerificationSamlVerificationObject> object) {
        Utils.checkNotNull(object, "object");
        this.object = object;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withStatus(VerificationSamlVerificationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withStrategy(VerificationSamlVerificationStrategy strategy) {
        Utils.checkNotNull(strategy, "strategy");
        this.strategy = strategy;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withExternalVerificationRedirectUrl(String externalVerificationRedirectUrl) {
        Utils.checkNotNull(externalVerificationRedirectUrl, "externalVerificationRedirectUrl");
        this.externalVerificationRedirectUrl = JsonNullable.of(externalVerificationRedirectUrl);
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withExternalVerificationRedirectUrl(JsonNullable<String> externalVerificationRedirectUrl) {
        Utils.checkNotNull(externalVerificationRedirectUrl, "externalVerificationRedirectUrl");
        this.externalVerificationRedirectUrl = externalVerificationRedirectUrl;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withError(VerificationError error) {
        Utils.checkNotNull(error, "error");
        this.error = JsonNullable.of(error);
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withError(JsonNullable<? extends VerificationError> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withExpireAt(long expireAt) {
        Utils.checkNotNull(expireAt, "expireAt");
        this.expireAt = JsonNullable.of(expireAt);
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withExpireAt(JsonNullable<Long> expireAt) {
        Utils.checkNotNull(expireAt, "expireAt");
        this.expireAt = expireAt;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withAttempts(long attempts) {
        Utils.checkNotNull(attempts, "attempts");
    ...
    public VerificationSAMLVerificationEmailAddressSAML withAttempts(Optional<Long> attempts) {
        Utils.checkNotNull(attempts, "attempts");
        this.attempts = attempts;
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withVerifiedAtClient(String verifiedAtClient) {
        Utils.checkNotNull(verifiedAtClient, "verifiedAtClient");
        this.verifiedAtClient = JsonNullable.of(verifiedAtClient);
        return this;
    }

    public VerificationSAMLVerificationEmailAddressSAML withVerifiedAtClient(JsonNullable<String> verifiedAtClient) {
        Utils.checkNotNull(verifiedAtClient, "verifiedAtClient");
        this.verifiedAtClient = verifiedAtClient;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VerificationSAMLVerificationEmailAddressSAML other = (VerificationSAMLVerificationEmailAddressSAML) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VerificationSAMLVerificationEmailAddressSAML.class,
                "object", object,
                "status", status,
                "strategy", strategy,
    ...
    public final static class Builder {
        ...
        public VerificationSAMLVerificationEmailAddressSAML build() {
