...
public class OrganizationInvitationPublicOrganizationData {
    ...
    @JsonCreator
    public OrganizationInvitationPublicOrganizationData(
    ...
    public OrganizationInvitationPublicOrganizationData withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public OrganizationInvitationPublicOrganizationData withSlug(String slug) {
        Utils.checkNotNull(slug, "slug");
        this.slug = slug;
        return this;
    }

    public OrganizationInvitationPublicOrganizationData withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
    ...
    public OrganizationInvitationPublicOrganizationData withHasImage(boolean hasImage) {
        Utils.checkNotNull(hasImage, "hasImage");
        this.hasImage = hasImage;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(OrganizationInvitationPublicOrganizationData.class,
                "id", id,
                "name", name,
                "slug", slug,
                "imageUrl", imageUrl,
