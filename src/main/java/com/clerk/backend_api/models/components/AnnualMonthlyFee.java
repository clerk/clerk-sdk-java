...
public class AnnualMonthlyFee {
     ...
     * The amount in cents.
     */
    public AnnualMonthlyFee withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public AnnualMonthlyFee withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public AnnualMonthlyFee withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public AnnualMonthlyFee withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AnnualMonthlyFee other = (AnnualMonthlyFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AnnualMonthlyFee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public AnnualMonthlyFee build() {

            return new AnnualMonthlyFee(
                amount, amountFormatted, currency,
                currencySymbol);
        }
