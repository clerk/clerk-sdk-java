 ...
 * ImmediateCharge
 * 
 * <p>Amount charged immediately, if any.
 */
public class ImmediateCharge {
     ...
     * The amount in cents.
     */
    public ImmediateCharge withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public ImmediateCharge withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public ImmediateCharge withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public ImmediateCharge withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ImmediateCharge other = (ImmediateCharge) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ImmediateCharge.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public ImmediateCharge build() {

            return new ImmediateCharge(
                amount, amountFormatted, currency,
                currencySymbol);
        }
