...
public class JWKSEd25519PrivateKey {
    ...
    @JsonProperty("kty")
    private JWKSEd25519PrivateKeyKty kty;

    @JsonProperty("crv")
    private JWKSEd25519PrivateKeyCrv crv;
    ...
    @JsonCreator
    public JWKSEd25519PrivateKey(
            @JsonProperty("kid") String kid,
            @JsonProperty("alg") String alg,
            @JsonProperty("use") String use,
            @JsonProperty("kty") JWKSEd25519PrivateKeyKty kty,
            @JsonProperty("crv") JWKSEd25519PrivateKeyCrv crv,
    ...
    public JWKSEd25519PrivateKey(
            ...
            String alg,
            String use,
            JWKSEd25519PrivateKeyKty kty,
            JWKSEd25519PrivateKeyCrv crv,
            String x,
            String d) {
        this(kid, alg, use, kty, crv, x, d, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    @JsonIgnore
    public JWKSEd25519PrivateKeyKty kty() {
        return kty;
    }

    @JsonIgnore
    public JWKSEd25519PrivateKeyCrv crv() {
        return crv;
    }
    ...
    public JWKSEd25519PrivateKey withKid(String kid) {
        Utils.checkNotNull(kid, "kid");
        this.kid = kid;
        return this;
    }

    public JWKSEd25519PrivateKey withAlg(String alg) {
        Utils.checkNotNull(alg, "alg");
        this.alg = alg;
        return this;
    }

    public JWKSEd25519PrivateKey withUse(String use) {
        Utils.checkNotNull(use, "use");
        this.use = use;
        return this;
    }

    public JWKSEd25519PrivateKey withKty(JWKSEd25519PrivateKeyKty kty) {
        Utils.checkNotNull(kty, "kty");
        this.kty = kty;
        return this;
    }

    public JWKSEd25519PrivateKey withCrv(JWKSEd25519PrivateKeyCrv crv) {
        Utils.checkNotNull(crv, "crv");
        this.crv = crv;
        return this;
    }

    public JWKSEd25519PrivateKey withX(String x) {
        Utils.checkNotNull(x, "x");
        this.x = x;
        return this;
    }

    public JWKSEd25519PrivateKey withD(String d) {
        Utils.checkNotNull(d, "d");
        this.d = d;
        return this;
    }

    public JWKSEd25519PrivateKey withX5c(List<String> x5c) {
        Utils.checkNotNull(x5c, "x5c");
        this.x5c = Optional.ofNullable(x5c);
        return this;
    }

    public JWKSEd25519PrivateKey withX5c(Optional<? extends List<String>> x5c) {
        Utils.checkNotNull(x5c, "x5c");
        this.x5c = x5c;
        return this;
    }

    public JWKSEd25519PrivateKey withX5t(String x5t) {
        Utils.checkNotNull(x5t, "x5t");
        this.x5t = Optional.ofNullable(x5t);
        return this;
    }

    public JWKSEd25519PrivateKey withX5t(Optional<String> x5t) {
        Utils.checkNotNull(x5t, "x5t");
        this.x5t = x5t;
        return this;
    }

    public JWKSEd25519PrivateKey withX5tNumberS256(String x5tNumberS256) {
        Utils.checkNotNull(x5tNumberS256, "x5tNumberS256");
        this.x5tNumberS256 = Optional.ofNullable(x5tNumberS256);
        return this;
    }

    public JWKSEd25519PrivateKey withX5tNumberS256(Optional<String> x5tNumberS256) {
        Utils.checkNotNull(x5tNumberS256, "x5tNumberS256");
        this.x5tNumberS256 = x5tNumberS256;
        return this;
    }

    public JWKSEd25519PrivateKey withX5u(String x5u) {
        Utils.checkNotNull(x5u, "x5u");
        this.x5u = Optional.ofNullable(x5u);
        return this;
    }

    public JWKSEd25519PrivateKey withX5u(Optional<String> x5u) {
        Utils.checkNotNull(x5u, "x5u");
        this.x5u = x5u;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JWKSEd25519PrivateKey other = (JWKSEd25519PrivateKey) o;
        return 
    ...
    public String toString() {
        return Utils.toString(JWKSEd25519PrivateKey.class,
                "kid", kid,
                "alg", alg,
                "use", use,
                "kty", kty,
    ...
    public final static class Builder {
        ...
        public Builder kty(JWKSEd25519PrivateKeyKty kty) {
            Utils.checkNotNull(kty, "kty");
            this.kty = kty;
            return this;
        }

        public Builder crv(JWKSEd25519PrivateKeyCrv crv) {
            Utils.checkNotNull(crv, "crv");
            this.crv = crv;
            return this;
        }
        ...
        public JWKSEd25519PrivateKey build() {
            return new JWKSEd25519PrivateKey(
                kid,
                alg,
                use,
                kty,
