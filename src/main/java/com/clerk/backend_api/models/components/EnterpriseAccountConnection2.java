...
public class EnterpriseAccountConnection2 {
    ...
    @JsonCreator
    public EnterpriseAccountConnection2(
    ...
    public EnterpriseAccountConnection2 withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public EnterpriseAccountConnection2 withProtocol(String protocol) {
        Utils.checkNotNull(protocol, "protocol");
        this.protocol = protocol;
        return this;
    }

    public EnterpriseAccountConnection2 withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }

    public EnterpriseAccountConnection2 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public EnterpriseAccountConnection2 withLogoPublicUrl(String logoPublicUrl) {
        Utils.checkNotNull(logoPublicUrl, "logoPublicUrl");
    ...
    public EnterpriseAccountConnection2 withLogoPublicUrl(Optional<String> logoPublicUrl) {
        Utils.checkNotNull(logoPublicUrl, "logoPublicUrl");
        this.logoPublicUrl = logoPublicUrl;
        return this;
    }
     ...
     */
    @Deprecated
    public EnterpriseAccountConnection2 withDomain(String domain) {
        Utils.checkNotNull(domain, "domain");
     ...
     */
    @Deprecated
    public EnterpriseAccountConnection2 withDomain(Optional<String> domain) {
        Utils.checkNotNull(domain, "domain");
        this.domain = domain;
        return this;
    }

    public EnterpriseAccountConnection2 withDomains(List<String> domains) {
        Utils.checkNotNull(domains, "domains");
        this.domains = domains;
        return this;
    }

    public EnterpriseAccountConnection2 withActive(boolean active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }

    public EnterpriseAccountConnection2 withSyncUserAttributes(boolean syncUserAttributes) {
        Utils.checkNotNull(syncUserAttributes, "syncUserAttributes");
        this.syncUserAttributes = syncUserAttributes;
        return this;
    }

    public EnterpriseAccountConnection2 withAllowSubdomains(boolean allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
        this.allowSubdomains = allowSubdomains;
        return this;
    }

    public EnterpriseAccountConnection2 withAllowIdpInitiated(boolean allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
        this.allowIdpInitiated = allowIdpInitiated;
        return this;
    }

    public EnterpriseAccountConnection2 withDisableAdditionalIdentifications(boolean disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
        this.disableAdditionalIdentifications = disableAdditionalIdentifications;
        return this;
    }
     ...
     * Unix timestamp of creation.
     */
    public EnterpriseAccountConnection2 withCreatedAt(long createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Unix timestamp of last update.
     */
    public EnterpriseAccountConnection2 withUpdatedAt(long updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EnterpriseAccountConnection2 other = (EnterpriseAccountConnection2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EnterpriseAccountConnection2.class,
                "id", id,
                "protocol", protocol,
                "provider", provider,
                "name", name,
    ...
    public final static class Builder {
        ...
        public EnterpriseAccountConnection2 build() {

            return new EnterpriseAccountConnection2(
                id, protocol, provider,
                name, logoPublicUrl, domain,
                domains, active, syncUserAttributes,
                allowSubdomains, allowIdpInitiated, disableAdditionalIdentifications,
