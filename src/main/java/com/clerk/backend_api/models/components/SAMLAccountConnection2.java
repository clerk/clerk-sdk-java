...
public class SAMLAccountConnection2 {
    ...
    public SAMLAccountConnection2 withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public SAMLAccountConnection2 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     */
    @Deprecated
    public SAMLAccountConnection2 withDomain(String domain) {
        Utils.checkNotNull(domain, "domain");
     ...
     */
    @Deprecated
    public SAMLAccountConnection2 withDomain(Optional<String> domain) {
        Utils.checkNotNull(domain, "domain");
        this.domain = domain;
        return this;
    }

    public SAMLAccountConnection2 withDomains(List<String> domains) {
        Utils.checkNotNull(domains, "domains");
        this.domains = domains;
        return this;
    }

    public SAMLAccountConnection2 withActive(boolean active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }

    public SAMLAccountConnection2 withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }

    public SAMLAccountConnection2 withSyncUserAttributes(boolean syncUserAttributes) {
        Utils.checkNotNull(syncUserAttributes, "syncUserAttributes");
        this.syncUserAttributes = syncUserAttributes;
        return this;
    }

    public SAMLAccountConnection2 withAllowSubdomains(boolean allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
    ...
    public SAMLAccountConnection2 withAllowSubdomains(Optional<Boolean> allowSubdomains) {
        Utils.checkNotNull(allowSubdomains, "allowSubdomains");
        this.allowSubdomains = allowSubdomains;
        return this;
    }

    public SAMLAccountConnection2 withAllowIdpInitiated(boolean allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
    ...
    public SAMLAccountConnection2 withAllowIdpInitiated(Optional<Boolean> allowIdpInitiated) {
        Utils.checkNotNull(allowIdpInitiated, "allowIdpInitiated");
        this.allowIdpInitiated = allowIdpInitiated;
        return this;
    }

    public SAMLAccountConnection2 withDisableAdditionalIdentifications(boolean disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
    ...
    public SAMLAccountConnection2 withDisableAdditionalIdentifications(Optional<Boolean> disableAdditionalIdentifications) {
        Utils.checkNotNull(disableAdditionalIdentifications, "disableAdditionalIdentifications");
        this.disableAdditionalIdentifications = disableAdditionalIdentifications;
        return this;
    }
     ...
     * Unix timestamp of creation.
     */
    public SAMLAccountConnection2 withCreatedAt(long createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Unix timestamp of last update.
     */
    public SAMLAccountConnection2 withUpdatedAt(long updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SAMLAccountConnection2 other = (SAMLAccountConnection2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SAMLAccountConnection2.class,
                "id", id,
                "name", name,
                "domain", domain,
                "domains", domains,
    ...
    public final static class Builder {
        ...
        public SAMLAccountConnection2 build() {

            return new SAMLAccountConnection2(
                id, name, domain,
                domains, active, provider,
                syncUserAttributes, allowSubdomains, allowIdpInitiated,
                disableAdditionalIdentifications, createdAt, updatedAt);
