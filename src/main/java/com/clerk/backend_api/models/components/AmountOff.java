 ...
 * AmountOff
 * 
 * <p>Fixed amount off when the effect is fixed_amount.
 */
public class AmountOff {
     ...
     * The amount in cents.
     */
    public AmountOff withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The formatted amount as a string (e.g., "$49.99").
     */
    public AmountOff withAmountFormatted(String amountFormatted) {
        Utils.checkNotNull(amountFormatted, "amountFormatted");
        this.amountFormatted = amountFormatted;
        return this;
    }
     ...
     * The currency code (e.g., "USD").
     */
    public AmountOff withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The currency symbol (e.g., "$").
     */
    public AmountOff withCurrencySymbol(String currencySymbol) {
        Utils.checkNotNull(currencySymbol, "currencySymbol");
        this.currencySymbol = currencySymbol;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AmountOff.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public AmountOff build() {

            return new AmountOff(
                amount, amountFormatted, currency,
                currencySymbol);
        }
