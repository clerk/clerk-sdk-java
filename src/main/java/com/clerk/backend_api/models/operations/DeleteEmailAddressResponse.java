...
public class DeleteEmailAddressResponse implements com.clerk.backend_api.utils.Response {
     ...
     * HTTP response content type for this operation
     */
    public DeleteEmailAddressResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteEmailAddressResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteEmailAddressResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Deleted Object
     */
    public DeleteEmailAddressResponse withDeletedObject(com.clerk.backend_api.models.components.DeletedObject deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
     ...
     * Deleted Object
     */
    public DeleteEmailAddressResponse withDeletedObject(Optional<? extends com.clerk.backend_api.models.components.DeletedObject> deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
        this.deletedObject = deletedObject;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteEmailAddressResponse other = (DeleteEmailAddressResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteEmailAddressResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteEmailAddressResponse build() {
            return new DeleteEmailAddressResponse(
                contentType,
                statusCode,
                rawResponse,
                deletedObject);
