...
public class CreateOrganizationInvitationBulkRequestBody {
     ...
     * Defaults to `true`.
     */
    public CreateOrganizationInvitationBulkRequestBody withNotify(boolean notify_) {
        Utils.checkNotNull(notify_, "notify_");
     ...
     * Defaults to `true`.
     */
    public CreateOrganizationInvitationBulkRequestBody withNotify(JsonNullable<Boolean> notify_) {
        Utils.checkNotNull(notify_, "notify_");
        this.notify_ = notify_;
        return this;
    }
