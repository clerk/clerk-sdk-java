...
public class UpdatePhoneNumberResponse implements Response {
     ...
     * Success
     */
    public UpdatePhoneNumberResponse withPhoneNumber(PhoneNumber phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
     ...
     * Success
     */
    public UpdatePhoneNumberResponse withPhoneNumber(Optional<? extends PhoneNumber> phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
        this.phoneNumber = phoneNumber;
        return this;
    }
