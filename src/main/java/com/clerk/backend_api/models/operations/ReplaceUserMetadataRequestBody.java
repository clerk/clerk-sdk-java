...
public class ReplaceUserMetadataRequestBody {
     ...
     * The existing value will be replaced entirely with the new object.
     * 
     * <p>Note: Since this data can be modified from the frontend, it is not guaranteed to be safe.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    @JsonCreator
    public ReplaceUserMetadataRequestBody(
     ...
     * The existing value will be replaced entirely with the new object.
     */
    public ReplaceUserMetadataRequestBody withPublicMetadata(Map<String, Object> publicMetadata) {
        Utils.checkNotNull(publicMetadata, "publicMetadata");
     ...
     * The existing value will be replaced entirely with the new object.
     */
    public ReplaceUserMetadataRequestBody withPublicMetadata(Optional<? extends Map<String, Object>> publicMetadata) {
        Utils.checkNotNull(publicMetadata, "publicMetadata");
        this.publicMetadata = publicMetadata;
        return this;
    }
     ...
     * The existing value will be replaced entirely with the new object.
     */
    public ReplaceUserMetadataRequestBody withPrivateMetadata(Map<String, Object> privateMetadata) {
        Utils.checkNotNull(privateMetadata, "privateMetadata");
     ...
     * The existing value will be replaced entirely with the new object.
     */
    public ReplaceUserMetadataRequestBody withPrivateMetadata(Optional<? extends Map<String, Object>> privateMetadata) {
        Utils.checkNotNull(privateMetadata, "privateMetadata");
        this.privateMetadata = privateMetadata;
        return this;
    }
     ...
     * <p>Note: Since this data can be modified from the frontend, it is not guaranteed to be safe.
     */
    public ReplaceUserMetadataRequestBody withUnsafeMetadata(Map<String, Object> unsafeMetadata) {
        Utils.checkNotNull(unsafeMetadata, "unsafeMetadata");
     ...
     * <p>Note: Since this data can be modified from the frontend, it is not guaranteed to be safe.
     */
    public ReplaceUserMetadataRequestBody withUnsafeMetadata(Optional<? extends Map<String, Object>> unsafeMetadata) {
        Utils.checkNotNull(unsafeMetadata, "unsafeMetadata");
        this.unsafeMetadata = unsafeMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReplaceUserMetadataRequestBody other = (ReplaceUserMetadataRequestBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReplaceUserMetadataRequestBody.class,
    ...
    public final static class Builder {
        ...
        public ReplaceUserMetadataRequestBody build() {

            return new ReplaceUserMetadataRequestBody(
                publicMetadata, privateMetadata, unsafeMetadata);
        }
