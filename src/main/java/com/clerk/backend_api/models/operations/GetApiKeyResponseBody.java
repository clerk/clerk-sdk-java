...
public class GetApiKeyResponseBody {
    ...
    @JsonProperty("object")
    private GetApiKeyObject object;
    ...
    public GetApiKeyResponseBody(
            @JsonProperty("object") GetApiKeyObject object,
    ...
    public GetApiKeyResponseBody withObject(GetApiKeyObject object) {
        Utils.checkNotNull(object, "object");
        this.object = object;
        return this;
    }

    public GetApiKeyResponseBody withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public GetApiKeyResponseBody withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public GetApiKeyResponseBody withSubject(String subject) {
        Utils.checkNotNull(subject, "subject");
        this.subject = subject;
        return this;
    }

    public GetApiKeyResponseBody withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public GetApiKeyResponseBody withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = JsonNullable.of(description);
        return this;
    }

    public GetApiKeyResponseBody withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public GetApiKeyResponseBody withClaims(Object claims) {
        Utils.checkNotNull(claims, "claims");
    ...
    public GetApiKeyResponseBody withClaims(Optional<? extends Object> claims) {
        Utils.checkNotNull(claims, "claims");
        this.claims = claims;
        return this;
    }

    public GetApiKeyResponseBody withScopes(List<String> scopes) {
        Utils.checkNotNull(scopes, "scopes");
        this.scopes = scopes;
        return this;
    }

    public GetApiKeyResponseBody withRevoked(boolean revoked) {
        Utils.checkNotNull(revoked, "revoked");
        this.revoked = revoked;
        return this;
    }

    public GetApiKeyResponseBody withRevocationReason(String revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
    ...
    public GetApiKeyResponseBody withRevocationReason(Optional<String> revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
        this.revocationReason = revocationReason;
        return this;
    }

    public GetApiKeyResponseBody withExpired(boolean expired) {
        Utils.checkNotNull(expired, "expired");
        this.expired = expired;
        return this;
    }

    public GetApiKeyResponseBody withExpiration(double expiration) {
        Utils.checkNotNull(expiration, "expiration");
    ...
    public GetApiKeyResponseBody withExpiration(Optional<Double> expiration) {
        Utils.checkNotNull(expiration, "expiration");
        this.expiration = expiration;
        return this;
    }

    public GetApiKeyResponseBody withCreatedBy(String createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
    ...
    public GetApiKeyResponseBody withCreatedBy(Optional<String> createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
        this.createdBy = createdBy;
        return this;
    }

    public GetApiKeyResponseBody withLastUsedAt(double lastUsedAt) {
        Utils.checkNotNull(lastUsedAt, "lastUsedAt");
    ...
    public GetApiKeyResponseBody withLastUsedAt(Optional<Double> lastUsedAt) {
        Utils.checkNotNull(lastUsedAt, "lastUsedAt");
        this.lastUsedAt = lastUsedAt;
        return this;
    }

    public GetApiKeyResponseBody withCreatedAt(double createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }

    public GetApiKeyResponseBody withUpdatedAt(double updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetApiKeyResponseBody other = (GetApiKeyResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetApiKeyResponseBody.class,
                "object", object,
                "id", id,
                "type", type,
                "subject", subject,
    ...
    public final static class Builder {
        ...
        public Builder object(GetApiKeyObject object) {
            Utils.checkNotNull(object, "object");
            this.object = object;
            return this;
        }
        ...
        public GetApiKeyResponseBody build() {
            ...
            return new GetApiKeyResponseBody(
                object, id, type,
                subject, name, description,
                claims, scopes, revoked,
                revocationReason, expired, expiration,
