...
public class DeleteOAuthApplicationResponse implements com.clerk.backend_api.utils.Response {
     ...
     * HTTP response content type for this operation
     */
    public DeleteOAuthApplicationResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteOAuthApplicationResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteOAuthApplicationResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Deleted Object
     */
    public DeleteOAuthApplicationResponse withDeletedObject(com.clerk.backend_api.models.components.DeletedObject deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
     ...
     * Deleted Object
     */
    public DeleteOAuthApplicationResponse withDeletedObject(Optional<? extends com.clerk.backend_api.models.components.DeletedObject> deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
        this.deletedObject = deletedObject;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteOAuthApplicationResponse other = (DeleteOAuthApplicationResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteOAuthApplicationResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteOAuthApplicationResponse build() {
            return new DeleteOAuthApplicationResponse(
                contentType,
                statusCode,
                rawResponse,
                deletedObject);
