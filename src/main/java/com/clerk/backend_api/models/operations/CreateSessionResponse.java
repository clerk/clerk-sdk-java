...
public class CreateSessionResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateSessionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public CreateSessionResponse withSession(Optional<? extends Session> session) {
        Utils.checkNotNull(session, "session");
        this.session = session;
        return this;
    }
