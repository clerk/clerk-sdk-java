...
public class RevokeApiKeyResponseBody {
    ...
    @JsonProperty("object")
    private RevokeApiKeyObject object;
    ...
    public RevokeApiKeyResponseBody(
            @JsonProperty("object") RevokeApiKeyObject object,
    ...
    public RevokeApiKeyResponseBody withObject(RevokeApiKeyObject object) {
        Utils.checkNotNull(object, "object");
        this.object = object;
        return this;
    }

    public RevokeApiKeyResponseBody withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public RevokeApiKeyResponseBody withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public RevokeApiKeyResponseBody withSubject(String subject) {
        Utils.checkNotNull(subject, "subject");
        this.subject = subject;
        return this;
    }

    public RevokeApiKeyResponseBody withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public RevokeApiKeyResponseBody withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = JsonNullable.of(description);
        return this;
    }

    public RevokeApiKeyResponseBody withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public RevokeApiKeyResponseBody withClaims(Object claims) {
        Utils.checkNotNull(claims, "claims");
    ...
    public RevokeApiKeyResponseBody withClaims(Optional<? extends Object> claims) {
        Utils.checkNotNull(claims, "claims");
        this.claims = claims;
        return this;
    }

    public RevokeApiKeyResponseBody withScopes(List<String> scopes) {
        Utils.checkNotNull(scopes, "scopes");
        this.scopes = scopes;
        return this;
    }

    public RevokeApiKeyResponseBody withRevoked(boolean revoked) {
        Utils.checkNotNull(revoked, "revoked");
        this.revoked = revoked;
        return this;
    }

    public RevokeApiKeyResponseBody withRevocationReason(String revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
    ...
    public RevokeApiKeyResponseBody withRevocationReason(Optional<String> revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
        this.revocationReason = revocationReason;
        return this;
    }

    public RevokeApiKeyResponseBody withExpired(boolean expired) {
        Utils.checkNotNull(expired, "expired");
        this.expired = expired;
        return this;
    }
     ...
     * The timestamp for when the API key will expire, in milliseconds
     */
    public RevokeApiKeyResponseBody withExpiration(double expiration) {
        Utils.checkNotNull(expiration, "expiration");
     ...
     * The timestamp for when the API key will expire, in milliseconds
     */
    public RevokeApiKeyResponseBody withExpiration(Optional<Double> expiration) {
        Utils.checkNotNull(expiration, "expiration");
        this.expiration = expiration;
        return this;
    }

    public RevokeApiKeyResponseBody withCreatedBy(String createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
    ...
    public RevokeApiKeyResponseBody withCreatedBy(Optional<String> createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The timestamp for when the API key was last used, in milliseconds
     */
    public RevokeApiKeyResponseBody withLastUsedAt(double lastUsedAt) {
        Utils.checkNotNull(lastUsedAt, "lastUsedAt");
     ...
     * The timestamp for when the API key was last used, in milliseconds
     */
    public RevokeApiKeyResponseBody withLastUsedAt(Optional<Double> lastUsedAt) {
        Utils.checkNotNull(lastUsedAt, "lastUsedAt");
        this.lastUsedAt = lastUsedAt;
        return this;
    }
     ...
     * The timestamp for when the API key was created, in milliseconds
     */
    public RevokeApiKeyResponseBody withCreatedAt(double createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The timestamp for when the API key was last updated, in milliseconds
     */
    public RevokeApiKeyResponseBody withUpdatedAt(double updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RevokeApiKeyResponseBody other = (RevokeApiKeyResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RevokeApiKeyResponseBody.class,
                "object", object,
                "id", id,
                "type", type,
                "subject", subject,
    ...
    public final static class Builder {
        ...
        public Builder object(RevokeApiKeyObject object) {
            Utils.checkNotNull(object, "object");
            this.object = object;
            return this;
        }
        ...
        public RevokeApiKeyResponseBody build() {
            ...
            return new RevokeApiKeyResponseBody(
                object, id, type,
                subject, name, description,
                claims, scopes, revoked,
                revocationReason, expired, expiration,
