...
public class ExtendCommerceSubscriptionItemFreeTrialRequest {
    ...
    @JsonCreator
    public ExtendCommerceSubscriptionItemFreeTrialRequest(
     ...
     * The ID of the subscription item to extend the free trial for
     */
    public ExtendCommerceSubscriptionItemFreeTrialRequest withSubscriptionItemId(String subscriptionItemId) {
        Utils.checkNotNull(subscriptionItemId, "subscriptionItemId");
        this.subscriptionItemId = subscriptionItemId;
        return this;
    }
     ...
     * Parameters for extending the free trial
     */
    public ExtendCommerceSubscriptionItemFreeTrialRequest withExtendFreeTrialRequest(ExtendFreeTrialRequest extendFreeTrialRequest) {
        Utils.checkNotNull(extendFreeTrialRequest, "extendFreeTrialRequest");
        this.extendFreeTrialRequest = extendFreeTrialRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExtendCommerceSubscriptionItemFreeTrialRequest other = (ExtendCommerceSubscriptionItemFreeTrialRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ExtendCommerceSubscriptionItemFreeTrialRequest.class,
    ...
    public final static class Builder {
        ...
        public ExtendCommerceSubscriptionItemFreeTrialRequest build() {

            return new ExtendCommerceSubscriptionItemFreeTrialRequest(
                subscriptionItemId, extendFreeTrialRequest);
        }
