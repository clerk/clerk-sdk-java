...
public class GetUserBillingSubscriptionRequestBuilder {
    ...
    private GetUserBillingSubscriptionRequest buildRequest() {
        ...
        GetUserBillingSubscriptionRequest request = new GetUserBillingSubscriptionRequest(userId);

        return request;
    }

    public GetUserBillingSubscriptionResponse call() {
        ...
        GetUserBillingSubscriptionRequest request = buildRequest();
