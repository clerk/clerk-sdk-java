...
public class CreateUserRequestBody {
     ...
     * `pbkdf2_sha512`, [`phpass`](https://www.openwall.com/phpass/), `md5_phpass`,
     ...
     * [`ldap_ssha`](https://www.openldap.org/faq/data/cache/347.html), the
     * [`argon2`](https://argon2.online/) variants: `argon2i` and `argon2id`, `sha512_symfony`, the SHA-512
     * variant of the [Symfony](https://symfony.com/doc/current/security/passwords.html) legacy hasher,
    ...
    public CreateUserRequestBody(
            ...
            @JsonProperty("password_digest") JsonNullable<String> passwordDigest,
     ...
     */
    @JsonIgnore
    public JsonNullable<String> passwordDigest() {
    ...
    public CreateUserRequestBody withPasswordDigest(String passwordDigest) {
        Utils.checkNotNull(passwordDigest, "passwordDigest");
        this.passwordDigest = JsonNullable.of(passwordDigest);
        return this;
    }
     ...
     * The hashing algorithm can be specified using the `password_hasher` property.
     */
    public CreateUserRequestBody withPasswordDigest(JsonNullable<String> passwordDigest) {
        Utils.checkNotNull(passwordDigest, "passwordDigest");
        this.passwordDigest = passwordDigest;
        return this;
    }
     ...
     * Upon migration the user base should be prompted to pick stronger password.
     */
    public CreateUserRequestBody withSkipPasswordChecks(JsonNullable<Boolean> skipPasswordChecks) {
        Utils.checkNotNull(skipPasswordChecks, "skipPasswordChecks");
        this.skipPasswordChecks = skipPasswordChecks;
        return this;
    }
    ...
    public CreateUserRequestBody withSkipPasswordRequirement(boolean skipPasswordRequirement) {
        Utils.checkNotNull(skipPasswordRequirement, "skipPasswordRequirement");
        this.skipPasswordRequirement = JsonNullable.of(skipPasswordRequirement);
        return this;
    }
     ...
     * * Algorithm: SHA1
     */
    public CreateUserRequestBody withTotpSecret(JsonNullable<String> totpSecret) {
        Utils.checkNotNull(totpSecret, "totpSecret");
        this.totpSecret = totpSecret;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The hashing algorithm can be specified using the `password_hasher` property.
         */
        public Builder passwordDigest(JsonNullable<String> passwordDigest) {
            Utils.checkNotNull(passwordDigest, "passwordDigest");
            this.passwordDigest = passwordDigest;
            return this;
        }
