...
public class DeleteJWTTemplateResponse implements com.clerk.backend_api.utils.Response {
    ...
    @JsonCreator
    public DeleteJWTTemplateResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public DeleteJWTTemplateResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteJWTTemplateResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteJWTTemplateResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Deleted Object
     */
    public DeleteJWTTemplateResponse withDeletedObject(com.clerk.backend_api.models.components.DeletedObject deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
     ...
     * Deleted Object
     */
    public DeleteJWTTemplateResponse withDeletedObject(Optional<? extends com.clerk.backend_api.models.components.DeletedObject> deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
        this.deletedObject = deletedObject;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteJWTTemplateResponse other = (DeleteJWTTemplateResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteJWTTemplateResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteJWTTemplateResponse build() {
            return new DeleteJWTTemplateResponse(
                contentType,
                statusCode,
                rawResponse,
                deletedObject);
