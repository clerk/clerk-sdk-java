...
public class GetBillingPriceListRequest {
    ...
    @JsonCreator
    public GetBillingPriceListRequest(
     ...
     * If false, the results will not be paginated.
     */
    public GetBillingPriceListRequest withPaginated(boolean paginated) {
        Utils.checkNotNull(paginated, "paginated");
     ...
     * If false, the results will not be paginated.
     */
    public GetBillingPriceListRequest withPaginated(Optional<Boolean> paginated) {
        Utils.checkNotNull(paginated, "paginated");
        this.paginated = paginated;
        return this;
    }
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public GetBillingPriceListRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public GetBillingPriceListRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * To be used in conjunction with `limit`.
     */
    public GetBillingPriceListRequest withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * To be used in conjunction with `limit`.
     */
    public GetBillingPriceListRequest withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
     ...
     * Filter prices by plan ID
     */
    public GetBillingPriceListRequest withPlanId(String planId) {
        Utils.checkNotNull(planId, "planId");
     ...
     * Filter prices by plan ID
     */
    public GetBillingPriceListRequest withPlanId(Optional<String> planId) {
        Utils.checkNotNull(planId, "planId");
        this.planId = planId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBillingPriceListRequest other = (GetBillingPriceListRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBillingPriceListRequest.class,
                "paginated", paginated,
                "limit", limit,
                "offset", offset,
                "planId", planId);
    ...
    public final static class Builder {
        ...
        public GetBillingPriceListRequest build() {
            if (limit == null) {
            ...
            return new GetBillingPriceListRequest(
                paginated, limit, offset,
                planId);
        }
