...
public class VerifySessionResponse implements com.clerk.backend_api.utils.Response {
     ...
     * Success
     */
    public VerifySessionResponse withSession(com.clerk.backend_api.models.components.Session session) {
        Utils.checkNotNull(session, "session");
     ...
     * Success
     */
    public VerifySessionResponse withSession(Optional<? extends com.clerk.backend_api.models.components.Session> session) {
        Utils.checkNotNull(session, "session");
        this.session = session;
        return this;
    }
