...
public class CreateInvitationRequestBody {
    ...
    private Optional<? extends TemplateSlug> templateSlug;
    ...
    public CreateInvitationRequestBody(
            ...
            @JsonProperty("template_slug") Optional<? extends TemplateSlug> templateSlug) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<TemplateSlug> templateSlug() {
     ...
     * The slug of the email template to use for the invitation email.
     */
    public CreateInvitationRequestBody withTemplateSlug(Optional<? extends TemplateSlug> templateSlug) {
        Utils.checkNotNull(templateSlug, "templateSlug");
        this.templateSlug = templateSlug;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The slug of the email template to use for the invitation email.
         */
        public Builder templateSlug(Optional<? extends TemplateSlug> templateSlug) {
            Utils.checkNotNull(templateSlug, "templateSlug");
            this.templateSlug = templateSlug;
            return this;
        }
