...
public class ListJWTTemplatesRequest {
    ...
    @JsonCreator
    public ListJWTTemplatesRequest(
     ...
     * If false, the results will not be paginated.
     */
    public ListJWTTemplatesRequest withPaginated(boolean paginated) {
        Utils.checkNotNull(paginated, "paginated");
     ...
     * If false, the results will not be paginated.
     */
    public ListJWTTemplatesRequest withPaginated(Optional<Boolean> paginated) {
        Utils.checkNotNull(paginated, "paginated");
        this.paginated = paginated;
        return this;
    }
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListJWTTemplatesRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListJWTTemplatesRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * To be used in conjunction with `limit`.
     */
    public ListJWTTemplatesRequest withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * To be used in conjunction with `limit`.
     */
    public ListJWTTemplatesRequest withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListJWTTemplatesRequest other = (ListJWTTemplatesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListJWTTemplatesRequest.class,
                "paginated", paginated,
                "limit", limit,
                "offset", offset);
    }
    ...
    public final static class Builder {
        ...
        public ListJWTTemplatesRequest build() {
            if (limit == null) {
            ...
            return new ListJWTTemplatesRequest(
                paginated, limit, offset);
        }
