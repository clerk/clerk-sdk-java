...
public class ListOAuthApplicationsRequestBuilder {
    ...
    public ListOAuthApplicationsRequestBuilder limit(Optional<? extends Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
    ...
    public ListOAuthApplicationsRequestBuilder offset(Optional<? extends Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
