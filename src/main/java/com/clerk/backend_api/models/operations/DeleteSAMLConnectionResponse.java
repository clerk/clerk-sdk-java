...
public class DeleteSAMLConnectionResponse implements com.clerk.backend_api.utils.Response {
    ...
    @JsonCreator
    public DeleteSAMLConnectionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public DeleteSAMLConnectionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteSAMLConnectionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteSAMLConnectionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Deleted Object
     */
    public DeleteSAMLConnectionResponse withDeletedObject(com.clerk.backend_api.models.components.DeletedObject deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
     ...
     * Deleted Object
     */
    public DeleteSAMLConnectionResponse withDeletedObject(Optional<? extends com.clerk.backend_api.models.components.DeletedObject> deletedObject) {
        Utils.checkNotNull(deletedObject, "deletedObject");
        this.deletedObject = deletedObject;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteSAMLConnectionResponse other = (DeleteSAMLConnectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteSAMLConnectionResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteSAMLConnectionResponse build() {
            return new DeleteSAMLConnectionResponse(
                contentType,
                statusCode,
                rawResponse,
                deletedObject);
