...
/**
 * UpdateUserPasswordHasher - The hashing algorithm that was used to generate the password digest.
 ...
 */
public enum UpdateUserPasswordHasher {
    ARGON2I("argon2i"),
    ARGON2ID("argon2id"),
    BCRYPT("bcrypt"),
    ...
    private UpdateUserPasswordHasher(String value) {
        this.value = value;
    }
