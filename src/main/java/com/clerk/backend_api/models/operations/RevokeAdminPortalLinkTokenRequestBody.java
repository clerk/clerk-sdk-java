...
public class RevokeAdminPortalLinkTokenRequestBody {
    ...
    @JsonCreator
    public RevokeAdminPortalLinkTokenRequestBody(
    ...
    public RevokeAdminPortalLinkTokenRequestBody withRevocationReason(String revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
        this.revocationReason = JsonNullable.of(revocationReason);
        return this;
    }

    public RevokeAdminPortalLinkTokenRequestBody withRevocationReason(JsonNullable<String> revocationReason) {
        Utils.checkNotNull(revocationReason, "revocationReason");
        this.revocationReason = revocationReason;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RevokeAdminPortalLinkTokenRequestBody other = (RevokeAdminPortalLinkTokenRequestBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RevokeAdminPortalLinkTokenRequestBody.class,
    ...
    public final static class Builder {
        ...
        public RevokeAdminPortalLinkTokenRequestBody build() {

            return new RevokeAdminPortalLinkTokenRequestBody(
                revocationReason);
        }
