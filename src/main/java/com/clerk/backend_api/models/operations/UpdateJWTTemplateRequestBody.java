...
public class UpdateJWTTemplateRequestBody {
     ...
     * JWT template name
     */
    public UpdateJWTTemplateRequestBody withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * JWT token lifetime
     */
    public UpdateJWTTemplateRequestBody withLifetime(JsonNullable<? extends Double> lifetime) {
        Utils.checkNotNull(lifetime, "lifetime");
        this.lifetime = lifetime;
        return this;
    }
     ...
     * JWT token allowed clock skew
     */
    public UpdateJWTTemplateRequestBody withAllowedClockSkew(JsonNullable<? extends Double> allowedClockSkew) {
        Utils.checkNotNull(allowedClockSkew, "allowedClockSkew");
        this.allowedClockSkew = allowedClockSkew;
        return this;
    }
     ...
     * Whether a custom signing key/algorithm is also provided for this template
     */
    public UpdateJWTTemplateRequestBody withCustomSigningKey(Optional<? extends Boolean> customSigningKey) {
        Utils.checkNotNull(customSigningKey, "customSigningKey");
        this.customSigningKey = customSigningKey;
        return this;
    }
     ...
     * The custom signing algorithm to use when minting JWTs
     */
    public UpdateJWTTemplateRequestBody withSigningAlgorithm(JsonNullable<? extends String> signingAlgorithm) {
        Utils.checkNotNull(signingAlgorithm, "signingAlgorithm");
        this.signingAlgorithm = signingAlgorithm;
        return this;
    }
     ...
     * The custom signing private key to use when minting JWTs
     */
    public UpdateJWTTemplateRequestBody withSigningKey(JsonNullable<? extends String> signingKey) {
        Utils.checkNotNull(signingKey, "signingKey");
        this.signingKey = signingKey;
        return this;
    }
