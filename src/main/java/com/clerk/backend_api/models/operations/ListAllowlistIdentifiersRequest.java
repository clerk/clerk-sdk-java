...
public class ListAllowlistIdentifiersRequest {
    ...
    @JsonCreator
    public ListAllowlistIdentifiersRequest(
     ...
     * If false, the results will not be paginated.
     */
    public ListAllowlistIdentifiersRequest withPaginated(boolean paginated) {
        Utils.checkNotNull(paginated, "paginated");
     ...
     * If false, the results will not be paginated.
     */
    public ListAllowlistIdentifiersRequest withPaginated(Optional<Boolean> paginated) {
        Utils.checkNotNull(paginated, "paginated");
        this.paginated = paginated;
        return this;
    }
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListAllowlistIdentifiersRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListAllowlistIdentifiersRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * To be used in conjunction with `limit`.
     */
    public ListAllowlistIdentifiersRequest withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * To be used in conjunction with `limit`.
     */
    public ListAllowlistIdentifiersRequest withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ListAllowlistIdentifiersRequest.class,
                "paginated", paginated,
                "limit", limit,
                "offset", offset);
    }
