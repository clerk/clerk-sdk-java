...
public class DeleteAWSCredentialResponse implements Response {
    /**
    ...
    @JsonCreator
    public DeleteAWSCredentialResponse(
            String contentType,
            int statusCode,
    ...
    public String toString() {
        return Utils.toString(DeleteAWSCredentialResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteAWSCredentialResponse build() {
            ...
            return new DeleteAWSCredentialResponse(
                contentType, statusCode, rawResponse,
                deletedObject);
        }
