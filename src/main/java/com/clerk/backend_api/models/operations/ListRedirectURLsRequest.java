...
public class ListRedirectURLsRequest {
    ...
    @JsonCreator
    public ListRedirectURLsRequest(
     ...
     * If false, the results will not be paginated.
     */
    public ListRedirectURLsRequest withPaginated(boolean paginated) {
        Utils.checkNotNull(paginated, "paginated");
     ...
     * If false, the results will not be paginated.
     */
    public ListRedirectURLsRequest withPaginated(Optional<Boolean> paginated) {
        Utils.checkNotNull(paginated, "paginated");
        this.paginated = paginated;
        return this;
    }
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListRedirectURLsRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Can be used for paginating the results together with `offset`.
     */
    public ListRedirectURLsRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * To be used in conjunction with `limit`.
     */
    public ListRedirectURLsRequest withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * To be used in conjunction with `limit`.
     */
    public ListRedirectURLsRequest withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListRedirectURLsRequest other = (ListRedirectURLsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListRedirectURLsRequest.class,
                "paginated", paginated,
                "limit", limit,
                "offset", offset);
    }
    ...
    public final static class Builder {
        ...
        public ListRedirectURLsRequest build() {
            if (limit == null) {
            ...
            return new ListRedirectURLsRequest(
                paginated,
                limit,
                offset);
        }
