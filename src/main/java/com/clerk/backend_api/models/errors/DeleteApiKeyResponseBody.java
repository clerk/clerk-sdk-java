...
public class DeleteApiKeyResponseBody extends ClerkError {
    ...
    /**
    * Parse a response into an instance of DeleteApiKeyResponseBody. If deserialization of the response body fails,
    ...
    */
    ...
    @Deprecated
    public Optional<List<DeleteApiKeyErrors>> errors() {
    ...
    public static class Data {
        ...
        @JsonProperty("errors")
        private List<DeleteApiKeyErrors> errors;

        @JsonCreator
        public Data(
                @JsonProperty("errors") List<DeleteApiKeyErrors> errors) {
            Utils.checkNotNull(errors, "errors");
            this.errors = errors;
        }

        @JsonIgnore
        public List<DeleteApiKeyErrors> errors() {
            return errors;
        }
        ...
        public Data withErrors(List<DeleteApiKeyErrors> errors) {
            Utils.checkNotNull(errors, "errors");
            this.errors = errors;
            return this;
        }
        ...
        public final static class Builder {
            ...
            public Builder errors(List<DeleteApiKeyErrors> errors) {
                Utils.checkNotNull(errors, "errors");
                this.errors = errors;
                return this;
            }
