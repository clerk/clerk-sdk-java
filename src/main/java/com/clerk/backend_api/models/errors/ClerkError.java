...
public abstract class ClerkError extends RuntimeException {

    private int code;
    private byte[] body;
    private HttpResponse<?> rawResponse;

    public ClerkError(String message, int code, @Nullable byte[] body, HttpResponse<?> rawResponse, @Nullable Throwable cause) {
        super(message, cause);
    ...
    public ClerkError withCode(int code) {
        this.code = code;
        return this;
    }
    
    public ClerkError withBody(@Nullable byte[] body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    
    public ClerkError withRawResponse(HttpResponse<?> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
