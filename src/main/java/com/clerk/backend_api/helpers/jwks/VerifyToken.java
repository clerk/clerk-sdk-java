...
public final class VerifyToken {
     ...
     */
    public static Claims verifyToken(String token, VerifyTokenOptions options) {
    ...
    /**
     * Converts a PEM formatted public key to a Key object
     * that can be used for networkless verification.
     *
     * @param jwtKey The PEM formatted public key.
     * @return The public key
     */
    private static Key getLocalJwtKey(String jwtKey) {
    ...
    /**
     * Retrieves the public key used to sign the token from Clerk's Backend API.
     *
     ...
     * @return The public key.
     * @throws TokenVerificationException if the key cannot be resolved.
     */
    private static final Key getRemoteJwtKey(String token, VerifyTokenOptions options) {
     ...
     */
    private static final String parseKid(String token) {
