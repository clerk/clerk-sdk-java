...
public class CreateBulkInvitationsOperation implements RequestOperation<Optional<? extends List<RequestBody>>, CreateBulkInvitationsResponse> {
    ...
    public CreateBulkInvitationsOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends List<RequestBody>> request) throws Exception {
