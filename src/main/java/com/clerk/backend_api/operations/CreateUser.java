...
public class CreateUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUserRequestBody, CreateUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CreateUserRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateUserRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUserRequestBody request) throws Exception {
