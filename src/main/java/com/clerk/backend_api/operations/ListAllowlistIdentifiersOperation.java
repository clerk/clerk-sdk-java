...
public class ListAllowlistIdentifiersOperation implements RequestOperation<ListAllowlistIdentifiersRequest, ListAllowlistIdentifiersResponse> {
    ...
    public ListAllowlistIdentifiersOperation(
    ...
    public HttpRequest buildRequest(ListAllowlistIdentifiersRequest request) throws Exception {
