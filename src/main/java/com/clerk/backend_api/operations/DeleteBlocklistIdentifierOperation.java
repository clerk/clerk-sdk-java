...
public class DeleteBlocklistIdentifierOperation implements RequestOperation<DeleteBlocklistIdentifierRequest, DeleteBlocklistIdentifierResponse> {
    ...
    public DeleteBlocklistIdentifierOperation(
    ...
    public HttpRequest buildRequest(DeleteBlocklistIdentifierRequest request) throws Exception {
