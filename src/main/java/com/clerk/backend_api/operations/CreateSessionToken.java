...
public class CreateSessionToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSessionTokenRequest, CreateSessionTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSessionTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSessionTokenRequest.class, new TypeReference<CreateSessionTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSessionTokenRequest request) {
        ...
        @Override
        public CreateSessionTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSessionTokenResponse.Builder resBuilder =
            ...
            CreateSessionTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateSessionTokenResponseBody>() {}));
                } else {
