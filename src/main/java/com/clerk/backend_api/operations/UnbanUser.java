...
public class UnbanUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UnbanUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnbanUserRequest, UnbanUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UnbanUserRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnbanUserRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "402", "4XX", "5XX")) {
        ...
        @Override
        public UnbanUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnbanUserResponse.Builder resBuilder =
                    UnbanUserResponse
                            .builder()
            ...
            UnbanUserResponse res = resBuilder.build();
