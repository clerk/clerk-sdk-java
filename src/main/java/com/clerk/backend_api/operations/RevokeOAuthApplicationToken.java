...
public class RevokeOAuthApplicationToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeOAuthApplicationTokenRequest, RevokeOAuthApplicationTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeOAuthApplicationTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeOAuthApplicationTokenRequest.class, new TypeReference<RevokeOAuthApplicationTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeOAuthApplicationTokenRequest request) {
        ...
        @Override
        public RevokeOAuthApplicationTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeOAuthApplicationTokenResponse.Builder resBuilder =
            ...
            RevokeOAuthApplicationTokenResponse res = resBuilder.build();
