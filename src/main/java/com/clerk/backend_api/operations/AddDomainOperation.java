...
public class AddDomainOperation implements RequestOperation<Optional<? extends AddDomainRequestBody>, AddDomainResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends AddDomainRequestBody> request) throws Exception {
