...
public class DeleteBackupCodeOperation implements RequestOperation<DeleteBackupCodeRequest, DeleteBackupCodeResponse> {
    ...
    public DeleteBackupCodeOperation(
    ...
    public HttpRequest buildRequest(DeleteBackupCodeRequest request) throws Exception {
