...
public class UpdateInstanceRestrictionsOperation implements RequestOperation<Optional<? extends UpdateInstanceRestrictionsRequestBody>, UpdateInstanceRestrictionsResponse> {
    ...
    public UpdateInstanceRestrictionsOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends UpdateInstanceRestrictionsRequestBody> request) throws Exception {
