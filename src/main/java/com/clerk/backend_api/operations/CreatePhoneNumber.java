...
public class CreatePhoneNumber {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreatePhoneNumberRequestBody> request) {
        ...
        @Override
        public CreatePhoneNumberResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPhoneNumber(Utils.unmarshal(response, new TypeReference<PhoneNumber>() {}));
                } else {
