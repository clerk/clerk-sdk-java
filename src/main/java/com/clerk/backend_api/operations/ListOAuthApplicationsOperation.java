...
public class ListOAuthApplicationsOperation implements RequestOperation<ListOAuthApplicationsRequest, ListOAuthApplicationsResponse> {
    ...
    public ListOAuthApplicationsOperation(
    ...
    public HttpRequest buildRequest(ListOAuthApplicationsRequest request) throws Exception {
