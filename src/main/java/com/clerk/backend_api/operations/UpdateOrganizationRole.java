...
public class UpdateOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateOrganizationRoleRequest, UpdateOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateOrganizationRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateOrganizationRoleRequest.class, new TypeReference<UpdateOrganizationRoleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationRoleRequest request) {
        ...
        @Override
        public UpdateOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateOrganizationRoleResponse.Builder resBuilder =
            ...
            UpdateOrganizationRoleResponse res = resBuilder.build();
