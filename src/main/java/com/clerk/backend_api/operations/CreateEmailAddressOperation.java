...
public class CreateEmailAddressOperation implements RequestOperation<Optional<? extends CreateEmailAddressRequestBody>, CreateEmailAddressResponse> {
    ...
    public CreateEmailAddressOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateEmailAddressRequestBody> request) throws Exception {
