...
public class CreateOAuthApplication {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateOAuthApplicationRequestBody> request) {
        ...
        @Override
        public CreateOAuthApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOAuthApplicationWithSecret(Utils.unmarshal(response, new TypeReference<OAuthApplicationWithSecret>() {}));
                } else {
