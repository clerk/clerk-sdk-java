...
public class CreateOAuthApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateOAuthApplicationRequestBody>, CreateOAuthApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateOAuthApplicationRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateOAuthApplicationRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateOAuthApplicationRequestBody> request) throws Exception {
        ...
        @Override
        public CreateOAuthApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOAuthApplicationResponse.Builder resBuilder =
            ...
            CreateOAuthApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OAuthApplicationWithSecret out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOAuthApplicationWithSecret(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
