...
public class RotateMachineSecretKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<RotateMachineSecretKeyRequest, RotateMachineSecretKeyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RotateMachineSecretKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RotateMachineSecretKeyRequest.class, new TypeReference<RotateMachineSecretKeyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RotateMachineSecretKeyRequest request) throws Exception {
        ...
        @Override
        public RotateMachineSecretKeyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RotateMachineSecretKeyResponse.Builder resBuilder =
            ...
            RotateMachineSecretKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MachineSecretKey out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMachineSecretKey(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
