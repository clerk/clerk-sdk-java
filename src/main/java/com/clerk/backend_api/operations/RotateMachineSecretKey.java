...
public class RotateMachineSecretKey {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RotateMachineSecretKeyRequest request) {
        ...
        @Override
        public RotateMachineSecretKeyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMachineSecretKey(Utils.unmarshal(response, new TypeReference<MachineSecretKey>() {}));
                } else {
