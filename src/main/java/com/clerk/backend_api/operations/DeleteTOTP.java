...
public class DeleteTOTP {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteTOTPRequest, DeleteTOTPResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteTOTPRequest request) {
        ...
        @Override
        public DeleteTOTPResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteTOTPResponseBody>() {}));
                } else {
