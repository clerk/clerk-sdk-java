...
public class ReplaceRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceRoleSetRequest, ReplaceRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceRoleSetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceRoleSetRequest.class, new TypeReference<ReplaceRoleSetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceRoleSetRequest request) {
        ...
        @Override
        public ReplaceRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceRoleSetResponse.Builder resBuilder =
            ...
            ReplaceRoleSetResponse res = resBuilder.build();
