...
public class LockUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(LockUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<LockUserRequest, LockUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(LockUserRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LockUserRequest request) throws Exception {
        ...
        @Override
        public LockUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LockUserResponse.Builder resBuilder =
                    LockUserResponse
                            .builder()
            ...
            LockUserResponse res = resBuilder.build();
