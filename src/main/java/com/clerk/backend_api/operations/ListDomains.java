...
public class ListDomains {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListDomainsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListDomainsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDomains(Utils.unmarshal(response, new TypeReference<Domains>() {}));
                } else {
