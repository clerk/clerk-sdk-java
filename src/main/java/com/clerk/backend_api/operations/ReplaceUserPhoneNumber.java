...
public class ReplaceUserPhoneNumber {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceUserPhoneNumberRequest, ReplaceUserPhoneNumberResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceUserPhoneNumberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceUserPhoneNumberRequest.class, new TypeReference<ReplaceUserPhoneNumberRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceUserPhoneNumberRequest request) {
        ...
        @Override
        public ReplaceUserPhoneNumberResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceUserPhoneNumberResponse.Builder resBuilder =
            ...
            ReplaceUserPhoneNumberResponse res = resBuilder.build();
