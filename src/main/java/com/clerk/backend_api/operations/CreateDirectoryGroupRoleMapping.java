...
public class CreateDirectoryGroupRoleMapping {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "CreateDirectoryGroupRoleMapping",
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDirectoryGroupRoleMappingRequest, CreateDirectoryGroupRoleMappingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateDirectoryGroupRoleMappingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDirectoryGroupRoleMappingRequest.class, new TypeReference<CreateDirectoryGroupRoleMappingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDirectoryGroupRoleMappingRequest request) {
        ...
        @Override
        public CreateDirectoryGroupRoleMappingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDirectoryGroupRoleMappingResponse.Builder resBuilder =
                    CreateDirectoryGroupRoleMappingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateDirectoryGroupRoleMappingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDirectoryGroupRoleMapping(Utils.unmarshal(response, new TypeReference<DirectoryGroupRoleMapping>() {}));
                } else {
