...
public class BanUserOperation implements RequestOperation<BanUserRequest, BanUserResponse> {
    ...
    public HttpRequest buildRequest(BanUserRequest request) throws Exception {
