...
public class AssignPermissionToOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<AssignPermissionToOrganizationRoleRequest, AssignPermissionToOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AssignPermissionToOrganizationRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssignPermissionToOrganizationRoleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssignPermissionToOrganizationRoleRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "409", "4XX", "5XX")) {
        ...
        @Override
        public AssignPermissionToOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AssignPermissionToOrganizationRoleResponse.Builder resBuilder =
            ...
            AssignPermissionToOrganizationRoleResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "404", "409")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
