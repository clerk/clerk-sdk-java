...
public class GetSCIMDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSCIMDirectoryRequest, GetSCIMDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSCIMDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSCIMDirectoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSCIMDirectoryRequest request) {
        ...
        @Override
        public GetSCIMDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSCIMDirectoryResponse.Builder resBuilder =
            ...
            GetSCIMDirectoryResponse res = resBuilder.build();
