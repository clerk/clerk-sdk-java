...
public class UpdatePhoneNumberOperation implements RequestOperation<UpdatePhoneNumberRequest, UpdatePhoneNumberResponse> {
    ...
    public UpdatePhoneNumberOperation(
    ...
    public HttpRequest buildRequest(UpdatePhoneNumberRequest request) throws Exception {
