...
public class CreateSAMLConnectionOperation implements RequestOperation<Optional<? extends CreateSAMLConnectionRequestBody>, CreateSAMLConnectionResponse> {
    ...
    public CreateSAMLConnectionOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateSAMLConnectionRequestBody> request) throws Exception {
