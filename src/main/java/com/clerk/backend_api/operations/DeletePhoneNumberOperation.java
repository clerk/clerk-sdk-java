...
public class DeletePhoneNumberOperation implements RequestOperation<DeletePhoneNumberRequest, DeletePhoneNumberResponse> {
    ...
    public DeletePhoneNumberOperation(
    ...
    public HttpRequest buildRequest(DeletePhoneNumberRequest request) throws Exception {
