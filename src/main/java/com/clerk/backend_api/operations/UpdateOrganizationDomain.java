...
public class UpdateOrganizationDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateOrganizationDomainRequest, UpdateOrganizationDomainResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UpdateOrganizationDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateOrganizationDomainRequest.class, new TypeReference<UpdateOrganizationDomainRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationDomainRequest request) throws Exception {
        ...
        @Override
        public UpdateOrganizationDomainResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateOrganizationDomainResponse.Builder resBuilder =
            ...
            UpdateOrganizationDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationDomain out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationDomain(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
