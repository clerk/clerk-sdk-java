...
public class UpdateOrganizationDomain {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationDomainRequest request) {
        ...
        @Override
        public UpdateOrganizationDomainResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationDomain(Utils.unmarshal(response, new TypeReference<OrganizationDomain>() {}));
                } else {
