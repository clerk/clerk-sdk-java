...
public class GetRedirectURLOperation implements RequestOperation<GetRedirectURLRequest, GetRedirectURLResponse> {
    ...
    public GetRedirectURLOperation(
    ...
    public HttpRequest buildRequest(GetRedirectURLRequest request) throws Exception {
