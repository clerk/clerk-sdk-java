...
public class ListSCIMDirectories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSCIMDirectoriesRequest, ListSCIMDirectoriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSCIMDirectoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSCIMDirectoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSCIMDirectoriesRequest request) {
        ...
        @Override
        public ListSCIMDirectoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSCIMDirectoriesResponse.Builder resBuilder =
            ...
            ListSCIMDirectoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSCIMDirectoryList(Utils.unmarshal(response, new TypeReference<SCIMDirectoryList>() {}));
                } else {
