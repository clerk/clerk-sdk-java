...
public class GetOrganizationPermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrganizationPermissionRequest, GetOrganizationPermissionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOrganizationPermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationPermissionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrganizationPermissionRequest request) {
        ...
        @Override
        public GetOrganizationPermissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrganizationPermissionResponse.Builder resBuilder =
            ...
            GetOrganizationPermissionResponse res = resBuilder.build();
