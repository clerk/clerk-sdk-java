...
public class GetRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRoleSetRequest, GetRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRoleSetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoleSetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoleSetRequest request) {
        ...
        @Override
        public GetRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRoleSetResponse.Builder resBuilder =
                    GetRoleSetResponse
                            .builder()
            ...
            GetRoleSetResponse res = resBuilder.build();
