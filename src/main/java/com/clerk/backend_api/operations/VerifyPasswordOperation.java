...
public class VerifyPasswordOperation implements RequestOperation<VerifyPasswordRequest, VerifyPasswordResponse> {
    ...
    public HttpRequest buildRequest(VerifyPasswordRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VerifyPasswordRequest request) throws Exception {
    ...
    @Override
    public VerifyPasswordResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VerifyPasswordResponse.Builder resBuilder = 
        ...
        VerifyPasswordResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VerifyPasswordResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400", "404", "422", "4XX")) {
            // no content 
            throw new SDKError(
                    response, 
                    response.statusCode(), 
