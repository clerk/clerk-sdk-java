...
import com.clerk.backend_api.models.operations.CreateApiKeyResponseBody;
...
public class CreateApiKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateApiKeyRequestBody, CreateApiKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateApiKeyRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateApiKeyRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateApiKeyRequestBody request) {
        ...
        @Override
        public CreateApiKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateApiKeyResponse.Builder resBuilder =
            ...
            CreateApiKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateApiKeyResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.CreateApiKeyResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "409")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateAPIKeyAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
