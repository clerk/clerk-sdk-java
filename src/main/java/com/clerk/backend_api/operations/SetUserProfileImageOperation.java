...
public class SetUserProfileImageOperation implements RequestOperation<SetUserProfileImageRequest, SetUserProfileImageResponse> {
    ...
    public SetUserProfileImageOperation(
    ...
    public HttpRequest buildRequest(SetUserProfileImageRequest request) throws Exception {
