...
public class GetUserBillingCreditBalance {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUserBillingCreditBalanceRequest, GetUserBillingCreditBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetUserBillingCreditBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUserBillingCreditBalanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserBillingCreditBalanceRequest request) {
        ...
        @Override
        public GetUserBillingCreditBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUserBillingCreditBalanceResponse.Builder resBuilder =
            ...
            GetUserBillingCreditBalanceResponse res = resBuilder.build();
