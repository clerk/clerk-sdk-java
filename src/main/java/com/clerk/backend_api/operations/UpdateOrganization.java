...
public class UpdateOrganization {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "402", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public UpdateOrganizationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Organization out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganization(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "402", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
