...
public class UpdateOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateOrganizationRequest, UpdateOrganizationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateOrganizationRequest.class, new TypeReference<UpdateOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationRequest request) {
        ...
        @Override
        public UpdateOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateOrganizationResponse.Builder resBuilder =
            ...
            UpdateOrganizationResponse res = resBuilder.build();
