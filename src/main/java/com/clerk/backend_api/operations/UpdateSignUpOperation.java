...
public class UpdateSignUpOperation implements RequestOperation<UpdateSignUpRequest, UpdateSignUpResponse> {
    ...
    public HttpRequest buildRequest(UpdateSignUpRequest request) throws Exception {
