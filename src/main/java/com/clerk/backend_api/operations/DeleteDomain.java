...
public class DeleteDomain {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteDomainRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDomainRequest, DeleteDomainResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeleteDomainRequest request) throws Exception {
