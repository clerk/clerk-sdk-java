...
public class CreateAllowlistIdentifier {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateAllowlistIdentifierRequestBody> request) {
        ...
        @Override
        public CreateAllowlistIdentifierResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAllowlistIdentifier(Utils.unmarshal(response, new TypeReference<AllowlistIdentifier>() {}));
                } else {
