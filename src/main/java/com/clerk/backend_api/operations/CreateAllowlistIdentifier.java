...
public class CreateAllowlistIdentifier {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateAllowlistIdentifierRequestBody>, CreateAllowlistIdentifierResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateAllowlistIdentifierRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateAllowlistIdentifierRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateAllowlistIdentifierRequestBody> request) throws Exception {
        ...
        @Override
        public CreateAllowlistIdentifierResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAllowlistIdentifierResponse.Builder resBuilder =
            ...
            CreateAllowlistIdentifierResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AllowlistIdentifier out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAllowlistIdentifier(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
