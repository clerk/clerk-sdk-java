...
public class UserPasskeyDelete {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UserPasskeyDeleteRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<UserPasskeyDeleteRequest, UserPasskeyDeleteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UserPasskeyDeleteRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UserPasskeyDeleteRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "403", "404", "4XX", "500", "5XX")) {
        ...
        @Override
        public UserPasskeyDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UserPasskeyDeleteResponse.Builder resBuilder =
            ...
            UserPasskeyDeleteResponse res = resBuilder.build();
