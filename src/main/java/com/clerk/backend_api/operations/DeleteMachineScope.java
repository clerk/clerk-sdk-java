...
public class DeleteMachineScope {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMachineScopeRequest request) {
        ...
        @Override
        public DeleteMachineScopeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMachineScopeDeleted(Utils.unmarshal(response, new TypeReference<MachineScopeDeleted>() {}));
                } else {
