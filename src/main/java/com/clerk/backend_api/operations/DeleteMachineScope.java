...
public class DeleteMachineScope {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMachineScopeRequest, DeleteMachineScopeResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMachineScopeRequest request) throws Exception {
        ...
        @Override
        public DeleteMachineScopeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMachineScopeResponse.Builder resBuilder =
            ...
            DeleteMachineScopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MachineScopeDeleted out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMachineScopeDeleted(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
