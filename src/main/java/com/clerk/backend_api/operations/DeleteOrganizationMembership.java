...
public class DeleteOrganizationMembership {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteOrganizationMembershipRequest, DeleteOrganizationMembershipResponse> {
            ...
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "404", "422", "4XX", "5XX")) {
        ...
        public DeleteOrganizationMembershipResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
