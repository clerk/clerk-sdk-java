...
public class DeleteDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDirectoryRequest, DeleteDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDirectoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDirectoryRequest request) {
        ...
        @Override
        public DeleteDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDirectoryResponse.Builder resBuilder =
            ...
            DeleteDirectoryResponse res = resBuilder.build();
