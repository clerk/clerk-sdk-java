...
public class RemoveBillingSubscriptionItemDiscount {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "RemoveBillingSubscriptionItemDiscount",
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveBillingSubscriptionItemDiscountRequest, RemoveBillingSubscriptionItemDiscountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveBillingSubscriptionItemDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveBillingSubscriptionItemDiscountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveBillingSubscriptionItemDiscountRequest request) {
        ...
        @Override
        public RemoveBillingSubscriptionItemDiscountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveBillingSubscriptionItemDiscountResponse.Builder resBuilder =
                    RemoveBillingSubscriptionItemDiscountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            RemoveBillingSubscriptionItemDiscountResponse res = resBuilder.build();
