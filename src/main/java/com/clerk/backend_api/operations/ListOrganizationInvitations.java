...
public class ListOrganizationInvitations {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListOrganizationInvitationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationInvitationsRequest, ListOrganizationInvitationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListOrganizationInvitationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationInvitationsRequest request) throws Exception {
        ...
        @Override
        public ListOrganizationInvitationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationInvitationsResponse.Builder resBuilder =
            ...
            ListOrganizationInvitationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationInvitations out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationInvitations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
