...
public class ListOrganizationInvitations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationInvitationsRequest request) {
        ...
        @Override
        public ListOrganizationInvitationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationInvitations(Utils.unmarshal(response, new TypeReference<OrganizationInvitations>() {}));
                } else {
