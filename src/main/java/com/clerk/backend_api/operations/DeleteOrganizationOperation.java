...
public class DeleteOrganizationOperation implements RequestOperation<DeleteOrganizationRequest, DeleteOrganizationResponse> {
    ...
    public HttpRequest buildRequest(DeleteOrganizationRequest request) throws Exception {
