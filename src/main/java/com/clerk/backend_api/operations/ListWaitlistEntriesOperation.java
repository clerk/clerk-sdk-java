...
public class ListWaitlistEntriesOperation implements RequestOperation<ListWaitlistEntriesRequest, ListWaitlistEntriesResponse> {
    ...
    public ListWaitlistEntriesOperation(
    ...
    public HttpRequest buildRequest(ListWaitlistEntriesRequest request) throws Exception {
