...
public class CreateJWTTemplateOperation implements RequestOperation<Optional<? extends CreateJWTTemplateRequestBody>, CreateJWTTemplateResponse> {
    ...
    public CreateJWTTemplateOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateJWTTemplateRequestBody> request) throws Exception {
