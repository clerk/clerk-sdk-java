...
public class AdjustOrganizationBillingCreditBalance {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "AdjustOrganizationBillingCreditBalance",
    ...
    public static class Sync extends Base
            implements RequestOperation<AdjustOrganizationBillingCreditBalanceRequest, AdjustOrganizationBillingCreditBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AdjustOrganizationBillingCreditBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AdjustOrganizationBillingCreditBalanceRequest.class, new TypeReference<AdjustOrganizationBillingCreditBalanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AdjustOrganizationBillingCreditBalanceRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "409", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public AdjustOrganizationBillingCreditBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AdjustOrganizationBillingCreditBalanceResponse.Builder resBuilder =
            ...
            AdjustOrganizationBillingCreditBalanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceCreditLedgerResponse(Utils.unmarshal(response, new TypeReference<CommerceCreditLedgerResponse>() {}));
                } else {
