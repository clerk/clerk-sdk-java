...
public class UploadOrganizationLogo {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadOrganizationLogoRequest, UploadOrganizationLogoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UploadOrganizationLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadOrganizationLogoRequest.class, new TypeReference<UploadOrganizationLogoRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadOrganizationLogoRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "403", "404", "413", "4XX", "5XX")) {
        ...
        @Override
        public UploadOrganizationLogoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadOrganizationLogoResponse.Builder resBuilder =
            ...
            UploadOrganizationLogoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationWithLogo out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationWithLogo(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
