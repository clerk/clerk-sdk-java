...
public class UploadOrganizationLogo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadOrganizationLogoRequest request) {
        ...
        @Override
        public UploadOrganizationLogoResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationWithLogo(Utils.unmarshal(response, new TypeReference<OrganizationWithLogo>() {}));
                } else {
