...
public class UpdateSAMLConnectionOperation implements RequestOperation<UpdateSAMLConnectionRequest, UpdateSAMLConnectionResponse> {
    ...
    public UpdateSAMLConnectionOperation(
    ...
    public HttpRequest buildRequest(UpdateSAMLConnectionRequest request) throws Exception {
