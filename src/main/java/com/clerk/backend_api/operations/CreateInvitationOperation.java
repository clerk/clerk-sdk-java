...
public class CreateInvitationOperation implements RequestOperation<Optional<? extends CreateInvitationRequestBody>, CreateInvitationResponse> {
    ...
    public CreateInvitationOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateInvitationRequestBody> request) throws Exception {
