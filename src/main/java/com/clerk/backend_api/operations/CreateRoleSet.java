...
public class CreateRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRoleSetRequestBody, CreateRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateRoleSetRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateRoleSetRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRoleSetRequestBody request) {
        ...
        @Override
        public CreateRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRoleSetResponse.Builder resBuilder =
            ...
            CreateRoleSetResponse res = resBuilder.build();
