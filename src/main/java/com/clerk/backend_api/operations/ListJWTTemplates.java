...
public class ListJWTTemplates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListJWTTemplatesRequest request) {
        ...
        @Override
        public ListJWTTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJWTTemplateList(Utils.unmarshal(response, new TypeReference<List<JWTTemplate>>() {}));
                } else {
