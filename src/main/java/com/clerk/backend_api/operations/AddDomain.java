...
public class AddDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends AddDomainRequestBody>, AddDomainResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends AddDomainRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends AddDomainRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends AddDomainRequestBody> request) {
        ...
        @Override
        public AddDomainResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddDomainResponse.Builder resBuilder =
                    AddDomainResponse
                            .builder()
            ...
            AddDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDomain(Utils.unmarshal(response, new TypeReference<Domain>() {}));
                } else {
