...
public class RevertTemplateOperation implements RequestOperation<RevertTemplateRequest, RevertTemplateResponse> {
    ...
    public RevertTemplateOperation(
    ...
    public HttpRequest buildRequest(RevertTemplateRequest request) throws Exception {
