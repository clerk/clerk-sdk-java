...
public class GetCommerceSubscriptionItemList {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceSubscriptionItemListRequest, GetCommerceSubscriptionItemListResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceSubscriptionItemListRequest request) throws Exception {
        ...
        @Override
        public GetCommerceSubscriptionItemListResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceSubscriptionItemListResponse.Builder resBuilder =
            ...
            GetCommerceSubscriptionItemListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaginatedCommerceSubscriptionItemResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaginatedCommerceSubscriptionItemResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
