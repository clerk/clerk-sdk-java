...
public class GetCommerceSubscriptionItemList {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceSubscriptionItemListRequest request) {
        ...
        @Override
        public GetCommerceSubscriptionItemListResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedCommerceSubscriptionItemResponse(Utils.unmarshal(response, new TypeReference<PaginatedCommerceSubscriptionItemResponse>() {}));
                } else {
