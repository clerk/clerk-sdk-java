...
public class RevokeAgentTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeAgentTaskRequest, RevokeAgentTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeAgentTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeAgentTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeAgentTaskRequest request) {
        ...
        @Override
        public RevokeAgentTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeAgentTaskResponse.Builder resBuilder =
            ...
            RevokeAgentTaskResponse res = resBuilder.build();
