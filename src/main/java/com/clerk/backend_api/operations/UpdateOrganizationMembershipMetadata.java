...
public class UpdateOrganizationMembershipMetadata {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationMembershipMetadataRequest request) {
        ...
        @Override
        public UpdateOrganizationMembershipMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationMembership(Utils.unmarshal(response, new TypeReference<OrganizationMembership>() {}));
                } else {
