...
public class UpdateOrganizationMembershipMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateOrganizationMembershipMetadataRequest, UpdateOrganizationMembershipMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UpdateOrganizationMembershipMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateOrganizationMembershipMetadataRequest.class, new TypeReference<UpdateOrganizationMembershipMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationMembershipMetadataRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public UpdateOrganizationMembershipMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateOrganizationMembershipMetadataResponse.Builder resBuilder =
            ...
            UpdateOrganizationMembershipMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationMembership out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationMembership(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
