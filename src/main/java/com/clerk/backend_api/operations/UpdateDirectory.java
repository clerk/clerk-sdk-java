...
public class UpdateDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDirectoryRequest, UpdateDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDirectoryRequest.class, new TypeReference<UpdateDirectoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDirectoryRequest request) {
        ...
        @Override
        public UpdateDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDirectoryResponse.Builder resBuilder =
            ...
            UpdateDirectoryResponse res = resBuilder.build();
