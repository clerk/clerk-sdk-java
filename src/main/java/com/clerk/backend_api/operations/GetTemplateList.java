...
public class GetTemplateList {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTemplateListRequest request) {
        ...
        @Override
        public GetTemplateListResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTemplateList(Utils.unmarshal(response, new TypeReference<List<Template>>() {}));
                } else {
