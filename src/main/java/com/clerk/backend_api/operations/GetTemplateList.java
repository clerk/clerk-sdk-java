...
public class GetTemplateList {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetTemplateListRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTemplateListRequest, GetTemplateListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetTemplateListRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTemplateListRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "422", "4XX", "5XX")) {
        ...
        @Override
        public GetTemplateListResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTemplateListResponse.Builder resBuilder =
            ...
            GetTemplateListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Template> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTemplateList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
