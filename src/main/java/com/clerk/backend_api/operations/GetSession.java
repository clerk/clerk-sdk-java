...
public class GetSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionRequest, GetSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionRequest request) {
        ...
        @Override
        public GetSessionResponse handleResponse(HttpResponse<InputStream> response) {
