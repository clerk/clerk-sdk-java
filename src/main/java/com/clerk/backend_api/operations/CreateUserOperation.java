...
public class CreateUserOperation implements RequestOperation<CreateUserRequestBody, CreateUserResponse> {
    ...
    public HttpRequest buildRequest(CreateUserRequestBody request) throws Exception {
