...
public class GetEnterpriseConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEnterpriseConnectionRequest, GetEnterpriseConnectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetEnterpriseConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEnterpriseConnectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEnterpriseConnectionRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "402", "403", "404", "4XX", "5XX")) {
        ...
        @Override
        public GetEnterpriseConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetEnterpriseConnectionResponse.Builder resBuilder =
            ...
            GetEnterpriseConnectionResponse res = resBuilder.build();
