...
public class UpdateDomainOperation implements RequestOperation<UpdateDomainRequest, UpdateDomainResponse> {
    ...
    public HttpRequest buildRequest(UpdateDomainRequest request) throws Exception {
