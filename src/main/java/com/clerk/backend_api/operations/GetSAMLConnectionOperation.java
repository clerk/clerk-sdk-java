...
public class GetSAMLConnectionOperation implements RequestOperation<GetSAMLConnectionRequest, GetSAMLConnectionResponse> {
    ...
    public GetSAMLConnectionOperation(
    ...
    public HttpRequest buildRequest(GetSAMLConnectionRequest request) throws Exception {
