...
public class GetBillingStatement {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBillingStatementRequest, GetBillingStatementResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBillingStatementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBillingStatementRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBillingStatementRequest request) {
        ...
        @Override
        public GetBillingStatementResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBillingStatementResponse.Builder resBuilder =
            ...
            GetBillingStatementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBillingStatement(Utils.unmarshal(response, new TypeReference<BillingStatement>() {}));
                } else {
