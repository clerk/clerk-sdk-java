...
public class GetOAuthApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOAuthApplicationRequest, GetOAuthApplicationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOAuthApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOAuthApplicationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOAuthApplicationRequest request) {
        ...
        @Override
        public GetOAuthApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOAuthApplicationResponse.Builder resBuilder =
