...
public class GetClientList {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetClientListRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClientListRequest, GetClientListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetClientListRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClientListRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "410", "422", "4XX", "5XX")) {
        ...
        @Override
        public GetClientListResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClientListResponse.Builder resBuilder =
            ...
            GetClientListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Client> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClientList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "410", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
