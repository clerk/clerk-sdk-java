...
public class GetClientList {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClientListRequest request) {
        ...
        @Override
        public GetClientListResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClientList(Utils.unmarshal(response, new TypeReference<List<Client>>() {}));
                } else {
