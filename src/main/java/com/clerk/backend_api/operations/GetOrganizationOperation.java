...
public class GetOrganizationOperation implements RequestOperation<GetOrganizationRequest, GetOrganizationResponse> {
    ...
    public HttpRequest buildRequest(GetOrganizationRequest request) throws Exception {
