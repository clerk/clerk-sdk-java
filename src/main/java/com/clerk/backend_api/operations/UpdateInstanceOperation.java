...
public class UpdateInstanceOperation implements RequestOperation<Optional<? extends UpdateInstanceRequestBody>, UpdateInstanceResponse> {
    ...
    public UpdateInstanceOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends UpdateInstanceRequestBody> request) throws Exception {
