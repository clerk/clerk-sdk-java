...
public class RevokeInvitation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeInvitationRequest request) {
        ...
        @Override
        public RevokeInvitationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvitationRevoked(Utils.unmarshal(response, new TypeReference<InvitationRevoked>() {}));
                } else {
