...
public class RevokeInvitation {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(RevokeInvitationRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeInvitationRequest, RevokeInvitationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevokeInvitationRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeInvitationRequest request) throws Exception {
        ...
        @Override
        public RevokeInvitationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeInvitationResponse.Builder resBuilder =
            ...
            RevokeInvitationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InvitationRevoked out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInvitationRevoked(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
