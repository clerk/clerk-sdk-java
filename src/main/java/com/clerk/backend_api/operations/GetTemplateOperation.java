...
public class GetTemplateOperation implements RequestOperation<GetTemplateRequest, GetTemplateResponse> {
    ...
    public HttpRequest buildRequest(GetTemplateRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTemplateRequest request) throws Exception {
    ...
    @Override
    public GetTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
