...
public class GetTemplateListOperation implements RequestOperation<GetTemplateListRequest, GetTemplateListResponse> {
    ...
    public GetTemplateListOperation(
    ...
    public HttpRequest buildRequest(GetTemplateListRequest request) throws Exception {
