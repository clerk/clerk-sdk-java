...
public class UpdateSCIMDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSCIMDirectoryRequest, UpdateSCIMDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateSCIMDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSCIMDirectoryRequest.class, new TypeReference<UpdateSCIMDirectoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSCIMDirectoryRequest request) {
        ...
        @Override
        public UpdateSCIMDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSCIMDirectoryResponse.Builder resBuilder =
            ...
            UpdateSCIMDirectoryResponse res = resBuilder.build();
