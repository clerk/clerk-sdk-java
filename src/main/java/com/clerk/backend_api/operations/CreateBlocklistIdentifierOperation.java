...
public class CreateBlocklistIdentifierOperation implements RequestOperation<Optional<? extends CreateBlocklistIdentifierRequestBody>, CreateBlocklistIdentifierResponse> {
    ...
    public CreateBlocklistIdentifierOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateBlocklistIdentifierRequestBody> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends CreateBlocklistIdentifierRequestBody> request) throws Exception {
    ...
    @Override
    public CreateBlocklistIdentifierResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateBlocklistIdentifierResponse.Builder resBuilder = 
        ...
        CreateBlocklistIdentifierResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BlocklistIdentifier out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withBlocklistIdentifier(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
