...
public class LockUserOperation implements RequestOperation<LockUserRequest, LockUserResponse> {
    ...
    public HttpRequest buildRequest(LockUserRequest request) throws Exception {
