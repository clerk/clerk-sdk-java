...
public class CreatePhoneNumberOperation implements RequestOperation<Optional<? extends CreatePhoneNumberRequestBody>, CreatePhoneNumberResponse> {
    ...
    public CreatePhoneNumberOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreatePhoneNumberRequestBody> request) throws Exception {
