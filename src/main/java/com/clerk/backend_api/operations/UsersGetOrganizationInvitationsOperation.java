...
public class UsersGetOrganizationInvitationsOperation implements RequestOperation<UsersGetOrganizationInvitationsRequest, UsersGetOrganizationInvitationsResponse> {
    ...
    public UsersGetOrganizationInvitationsOperation(
    ...
    public HttpRequest buildRequest(UsersGetOrganizationInvitationsRequest request) throws Exception {
