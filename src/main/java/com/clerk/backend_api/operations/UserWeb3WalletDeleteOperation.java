...
public class UserWeb3WalletDeleteOperation implements RequestOperation<UserWeb3WalletDeleteRequest, UserWeb3WalletDeleteResponse> {
    ...
    public UserWeb3WalletDeleteOperation(
    ...
    public HttpRequest buildRequest(UserWeb3WalletDeleteRequest request) throws Exception {
