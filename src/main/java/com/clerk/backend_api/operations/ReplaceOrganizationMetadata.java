...
public class ReplaceOrganizationMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceOrganizationMetadataRequest, ReplaceOrganizationMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceOrganizationMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceOrganizationMetadataRequest.class, new TypeReference<ReplaceOrganizationMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceOrganizationMetadataRequest request) {
        ...
        @Override
        public ReplaceOrganizationMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceOrganizationMetadataResponse.Builder resBuilder =
            ...
            ReplaceOrganizationMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganization(Utils.unmarshal(response, new TypeReference<Organization>() {}));
                } else {
