...
public class VerifyClientOperation implements RequestOperation<Optional<? extends VerifyClientRequestBody>, VerifyClientResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends VerifyClientRequestBody> request) throws Exception {
