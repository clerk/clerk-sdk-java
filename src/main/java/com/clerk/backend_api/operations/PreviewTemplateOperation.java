...
public class PreviewTemplateOperation implements RequestOperation<PreviewTemplateRequest, PreviewTemplateResponse> {
    ...
    public PreviewTemplateOperation(
    ...
    public HttpRequest buildRequest(PreviewTemplateRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PreviewTemplateRequest request) throws Exception {
    ...
    @Override
    public PreviewTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PreviewTemplateResponse.Builder resBuilder = 
        ...
        PreviewTemplateResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PreviewTemplateResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
