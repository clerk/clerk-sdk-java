...
public class CreateAllowlistIdentifierOperation implements RequestOperation<Optional<? extends CreateAllowlistIdentifierRequestBody>, CreateAllowlistIdentifierResponse> {
    ...
    public CreateAllowlistIdentifierOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateAllowlistIdentifierRequestBody> request) throws Exception {
