...
public class ListAllOrganizationDomains {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllOrganizationDomainsRequest request) {
        ...
        @Override
        public ListAllOrganizationDomainsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationDomains(Utils.unmarshal(response, new TypeReference<OrganizationDomains>() {}));
                } else {
