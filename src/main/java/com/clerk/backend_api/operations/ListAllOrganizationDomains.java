...
public class ListAllOrganizationDomains {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListAllOrganizationDomainsRequest request) throws Exception {
            ...
            req.addQueryParams(Utils.getQueryParams(
                    ListAllOrganizationDomainsRequest.class,
                    request,
                    null));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllOrganizationDomainsRequest, ListAllOrganizationDomainsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListAllOrganizationDomainsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllOrganizationDomainsRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "422", "4XX", "5XX")) {
        ...
        @Override
        public ListAllOrganizationDomainsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllOrganizationDomainsResponse.Builder resBuilder =
            ...
            ListAllOrganizationDomainsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationDomains out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationDomains(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
