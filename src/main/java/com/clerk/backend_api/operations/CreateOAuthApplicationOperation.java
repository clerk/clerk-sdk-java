...
public class CreateOAuthApplicationOperation implements RequestOperation<Optional<? extends CreateOAuthApplicationRequestBody>, CreateOAuthApplicationResponse> {
    ...
    public CreateOAuthApplicationOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateOAuthApplicationRequestBody> request) throws Exception {
