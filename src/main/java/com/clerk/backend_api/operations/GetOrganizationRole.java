...
public class GetOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrganizationRoleRequest, GetOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOrganizationRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationRoleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrganizationRoleRequest request) {
        ...
        @Override
        public GetOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrganizationRoleResponse.Builder resBuilder =
            ...
            GetOrganizationRoleResponse res = resBuilder.build();
