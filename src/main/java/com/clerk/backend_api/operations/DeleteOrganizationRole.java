...
public class DeleteOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteOrganizationRoleRequest, DeleteOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteOrganizationRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteOrganizationRoleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteOrganizationRoleRequest request) {
        ...
        @Override
        public DeleteOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteOrganizationRoleResponse.Builder resBuilder =
            ...
            DeleteOrganizationRoleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeletedObject(Utils.unmarshal(response, new TypeReference<DeletedObject>() {}));
                } else {
