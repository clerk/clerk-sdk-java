...
public class CreateBillingPriceTransition {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBillingPriceTransitionRequest, CreateBillingPriceTransitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateBillingPriceTransitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBillingPriceTransitionRequest.class, new TypeReference<CreateBillingPriceTransitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBillingPriceTransitionRequest request) {
        ...
        @Override
        public CreateBillingPriceTransitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBillingPriceTransitionResponse.Builder resBuilder =
            ...
            CreateBillingPriceTransitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommercePriceTransitionResponse(Utils.unmarshal(response, new TypeReference<CommercePriceTransitionResponse>() {}));
                } else {
