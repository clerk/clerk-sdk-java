...
public class UpdateJWTTemplateOperation implements RequestOperation<UpdateJWTTemplateRequest, UpdateJWTTemplateResponse> {
    ...
    public UpdateJWTTemplateOperation(
    ...
    public HttpRequest buildRequest(UpdateJWTTemplateRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateJWTTemplateRequest request) throws Exception {
    ...
    @Override
    public UpdateJWTTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
