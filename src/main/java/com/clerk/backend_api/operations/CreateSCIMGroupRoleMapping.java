...
public class CreateSCIMGroupRoleMapping {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSCIMGroupRoleMappingRequest, CreateSCIMGroupRoleMappingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSCIMGroupRoleMappingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSCIMGroupRoleMappingRequest.class, new TypeReference<CreateSCIMGroupRoleMappingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSCIMGroupRoleMappingRequest request) {
        ...
        @Override
        public CreateSCIMGroupRoleMappingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSCIMGroupRoleMappingResponse.Builder resBuilder =
                    CreateSCIMGroupRoleMappingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateSCIMGroupRoleMappingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSCIMGroupRoleMapping(Utils.unmarshal(response, new TypeReference<SCIMGroupRoleMapping>() {}));
                } else {
