...
public class UpdateInstanceAuthConfig {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceAuthConfigRequestBody> request) {
        ...
        @Override
        public UpdateInstanceAuthConfigResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInstanceSettings(Utils.unmarshal(response, new TypeReference<InstanceSettings>() {}));
                } else {
