...
public class RevokeOrganizationInvitation {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeOrganizationInvitationRequest, RevokeOrganizationInvitationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevokeOrganizationInvitationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeOrganizationInvitationRequest.class, new TypeReference<RevokeOrganizationInvitationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeOrganizationInvitationRequest request) throws Exception {
        ...
        @Override
        public RevokeOrganizationInvitationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeOrganizationInvitationResponse.Builder resBuilder =
            ...
            RevokeOrganizationInvitationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationInvitation out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationInvitation(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
