...
public class CreateBillingPrice {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBillingPriceRequest, CreateBillingPriceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateBillingPriceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateBillingPriceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBillingPriceRequest request) {
        ...
        @Override
        public CreateBillingPriceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBillingPriceResponse.Builder resBuilder =
            ...
            CreateBillingPriceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBillingPriceResponse(Utils.unmarshal(response, new TypeReference<BillingPriceResponse>() {}));
                } else {
