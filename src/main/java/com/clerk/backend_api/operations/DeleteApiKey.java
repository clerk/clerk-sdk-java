...
import com.clerk.backend_api.models.operations.DeleteApiKeyResponseBody;
...
public class DeleteApiKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteApiKeyRequest, DeleteApiKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteApiKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteApiKeyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteApiKeyRequest request) {
        ...
        @Override
        public DeleteApiKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteApiKeyResponse.Builder resBuilder =
            ...
            DeleteApiKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteApiKeyResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.DeleteApiKeyResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw DeleteAPIKeyAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
