...
public class RotateSCIMDirectoryAPIKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<RotateSCIMDirectoryAPIKeyRequest, RotateSCIMDirectoryAPIKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RotateSCIMDirectoryAPIKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RotateSCIMDirectoryAPIKeyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RotateSCIMDirectoryAPIKeyRequest request) {
        ...
        @Override
        public RotateSCIMDirectoryAPIKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RotateSCIMDirectoryAPIKeyResponse.Builder resBuilder =
            ...
            RotateSCIMDirectoryAPIKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSCIMDirectory(Utils.unmarshal(response, new TypeReference<SCIMDirectory>() {}));
                } else {
