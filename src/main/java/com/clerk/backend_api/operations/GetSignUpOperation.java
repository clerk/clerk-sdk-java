...
public class GetSignUpOperation implements RequestOperation<GetSignUpRequest, GetSignUpResponse> {
    ...
    public HttpRequest buildRequest(GetSignUpRequest request) throws Exception {
