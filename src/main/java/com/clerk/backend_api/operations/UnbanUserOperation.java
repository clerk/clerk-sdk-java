...
public class UnbanUserOperation implements RequestOperation<UnbanUserRequest, UnbanUserResponse> {
    ...
    public HttpRequest buildRequest(UnbanUserRequest request) throws Exception {
