...
public class UpdateInstanceAuthConfigOperation implements RequestOperation<Optional<? extends UpdateInstanceAuthConfigRequestBody>, UpdateInstanceAuthConfigResponse> {
    ...
    public UpdateInstanceAuthConfigOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends UpdateInstanceAuthConfigRequestBody> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceAuthConfigRequestBody> request) throws Exception {
    ...
    @Override
    public UpdateInstanceAuthConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UpdateInstanceAuthConfigResponse.Builder resBuilder = 
        ...
        UpdateInstanceAuthConfigResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                InstanceSettings out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withInstanceSettings(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
