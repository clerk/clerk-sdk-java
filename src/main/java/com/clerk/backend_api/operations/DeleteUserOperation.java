...
public class DeleteUserOperation implements RequestOperation<DeleteUserRequest, DeleteUserResponse> {
    ...
    public HttpRequest buildRequest(DeleteUserRequest request) throws Exception {
