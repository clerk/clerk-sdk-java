...
import com.clerk.backend_api.models.operations.GetApiKeySecretResponseBody;
...
public class GetApiKeySecret {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetApiKeySecretRequest, GetApiKeySecretResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetApiKeySecretRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetApiKeySecretRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetApiKeySecretRequest request) {
        ...
        @Override
        public GetApiKeySecretResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetApiKeySecretResponse.Builder resBuilder =
            ...
            GetApiKeySecretResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetApiKeySecretResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.GetApiKeySecretResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw GetAPIKeySecretAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
