...
public class CreateOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrganizationRoleRequestBody, CreateOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateOrganizationRoleRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateOrganizationRoleRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrganizationRoleRequestBody request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "402", "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public CreateOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOrganizationRoleResponse.Builder resBuilder =
            ...
            CreateOrganizationRoleResponse res = resBuilder.build();
