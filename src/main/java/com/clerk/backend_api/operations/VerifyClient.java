...
public class VerifyClient {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends VerifyClientRequestBody>, VerifyClientResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends VerifyClientRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends VerifyClientRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends VerifyClientRequestBody> request) {
        ...
        @Override
        public VerifyClientResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyClientResponse.Builder resBuilder =
            ...
            VerifyClientResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClient(Utils.unmarshal(response, new TypeReference<Client>() {}));
                } else {
