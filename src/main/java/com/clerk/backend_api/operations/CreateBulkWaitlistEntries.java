...
public class CreateBulkWaitlistEntries {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends List<CreateBulkWaitlistEntriesRequestBody>>, CreateBulkWaitlistEntriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends List<CreateBulkWaitlistEntriesRequestBody>> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends List<CreateBulkWaitlistEntriesRequestBody>>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends List<CreateBulkWaitlistEntriesRequestBody>> request) {
        ...
        @Override
        public CreateBulkWaitlistEntriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBulkWaitlistEntriesResponse.Builder resBuilder =
            ...
            CreateBulkWaitlistEntriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWaitlistEntryList(Utils.unmarshal(response, new TypeReference<List<WaitlistEntry>>() {}));
                } else {
