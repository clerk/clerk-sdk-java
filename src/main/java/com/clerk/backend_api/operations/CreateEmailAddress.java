...
public class CreateEmailAddress {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateEmailAddressRequestBody>, CreateEmailAddressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateEmailAddressRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateEmailAddressRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateEmailAddressRequestBody> request) throws Exception {
        ...
        @Override
        public CreateEmailAddressResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateEmailAddressResponse.Builder resBuilder =
            ...
            CreateEmailAddressResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmailAddress out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmailAddress(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
