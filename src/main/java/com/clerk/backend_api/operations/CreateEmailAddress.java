...
public class CreateEmailAddress {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateEmailAddressRequestBody> request) {
        ...
        @Override
        public CreateEmailAddressResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailAddress(Utils.unmarshal(response, new TypeReference<EmailAddress>() {}));
                } else {
