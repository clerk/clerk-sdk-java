...
public class ListOrganizationsOperation implements RequestOperation<ListOrganizationsRequest, ListOrganizationsResponse> {
    ...
    public HttpRequest buildRequest(ListOrganizationsRequest request) throws Exception {
