...
public class CreateActorTokenOperation implements RequestOperation<Optional<? extends CreateActorTokenRequestBody>, CreateActorTokenResponse> {
    ...
    public CreateActorTokenOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateActorTokenRequestBody> request) throws Exception {
