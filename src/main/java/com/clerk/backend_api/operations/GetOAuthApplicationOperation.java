...
public class GetOAuthApplicationOperation implements RequestOperation<GetOAuthApplicationRequest, GetOAuthApplicationResponse> {
    ...
    public GetOAuthApplicationOperation(
    ...
    public HttpRequest buildRequest(GetOAuthApplicationRequest request) throws Exception {
