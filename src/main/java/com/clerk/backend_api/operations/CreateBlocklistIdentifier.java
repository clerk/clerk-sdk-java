...
public class CreateBlocklistIdentifier {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateBlocklistIdentifierRequestBody> request) {
        ...
        @Override
        public CreateBlocklistIdentifierResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBlocklistIdentifier(Utils.unmarshal(response, new TypeReference<BlocklistIdentifier>() {}));
                } else {
