...
public class GetBillingPriceList {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBillingPriceListRequest, GetBillingPriceListResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBillingPriceListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBillingPriceListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBillingPriceListRequest request) {
        ...
        @Override
        public GetBillingPriceListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBillingPriceListResponse.Builder resBuilder =
            ...
            GetBillingPriceListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedBillingPriceResponse(Utils.unmarshal(response, new TypeReference<PaginatedBillingPriceResponse>() {}));
                } else {
