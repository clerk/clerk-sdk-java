...
public class ToggleTemplateDelivery {
    ...
    public static class Sync extends Base
            implements RequestOperation<ToggleTemplateDeliveryRequest, ToggleTemplateDeliveryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ToggleTemplateDeliveryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ToggleTemplateDeliveryRequest.class, new TypeReference<ToggleTemplateDeliveryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ToggleTemplateDeliveryRequest request) throws Exception {
        ...
        @Override
        public ToggleTemplateDeliveryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ToggleTemplateDeliveryResponse.Builder resBuilder =
            ...
            ToggleTemplateDeliveryResponse res = resBuilder.build();
