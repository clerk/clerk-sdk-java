...
public class UserWeb3WalletDelete {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UserWeb3WalletDeleteRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<UserWeb3WalletDeleteRequest, UserWeb3WalletDeleteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UserWeb3WalletDeleteRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UserWeb3WalletDeleteRequest request) throws Exception {
        ...
        @Override
        public UserWeb3WalletDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UserWeb3WalletDeleteResponse.Builder resBuilder =
            ...
            UserWeb3WalletDeleteResponse res = resBuilder.build();
