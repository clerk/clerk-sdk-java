...
public class GetDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDirectoryRequest, GetDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDirectoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDirectoryRequest request) {
        ...
        @Override
        public GetDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDirectoryResponse.Builder resBuilder =
            ...
            GetDirectoryResponse res = resBuilder.build();
