...
public class ReplaceDirectoryGroupRoleMappings {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "ReplaceDirectoryGroupRoleMappings",
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceDirectoryGroupRoleMappingsRequest, ReplaceDirectoryGroupRoleMappingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceDirectoryGroupRoleMappingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceDirectoryGroupRoleMappingsRequest.class, new TypeReference<ReplaceDirectoryGroupRoleMappingsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceDirectoryGroupRoleMappingsRequest request) {
        ...
        @Override
        public ReplaceDirectoryGroupRoleMappingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceDirectoryGroupRoleMappingsResponse.Builder resBuilder =
            ...
            ReplaceDirectoryGroupRoleMappingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDirectoryGroupRoleMappingList(Utils.unmarshal(response, new TypeReference<DirectoryGroupRoleMappingList>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
