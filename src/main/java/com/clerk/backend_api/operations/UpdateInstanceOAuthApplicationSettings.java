...
public class UpdateInstanceOAuthApplicationSettings {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "UpdateInstanceOAuthApplicationSettings",
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends UpdateInstanceOAuthApplicationSettingsRequestBody>, UpdateInstanceOAuthApplicationSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends UpdateInstanceOAuthApplicationSettingsRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends UpdateInstanceOAuthApplicationSettingsRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceOAuthApplicationSettingsRequestBody> request) {
        ...
        @Override
        public UpdateInstanceOAuthApplicationSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateInstanceOAuthApplicationSettingsResponse.Builder resBuilder =
            ...
            UpdateInstanceOAuthApplicationSettingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOAuthApplicationSettings(Utils.unmarshal(response, new TypeReference<OAuthApplicationSettings>() {}));
                } else {
