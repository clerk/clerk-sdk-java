...
public class GetOAuthAccessToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOAuthAccessTokenRequest request) {
        ...
        @Override
        public GetOAuthAccessTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOAuthAccessToken(Utils.unmarshal(response, new TypeReference<List<OAuthAccessToken>>() {}));
                } else {
