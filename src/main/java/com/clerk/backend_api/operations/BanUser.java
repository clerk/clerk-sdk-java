...
public class BanUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BanUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BanUserRequest, BanUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(BanUserRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BanUserRequest request) throws Exception {
        ...
        @Override
        public BanUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            BanUserResponse.Builder resBuilder =
                    BanUserResponse
                            .builder()
            ...
            BanUserResponse res = resBuilder.build();
