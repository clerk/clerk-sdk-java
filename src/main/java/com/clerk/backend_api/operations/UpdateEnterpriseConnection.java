...
public class UpdateEnterpriseConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateEnterpriseConnectionRequest, UpdateEnterpriseConnectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateEnterpriseConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateEnterpriseConnectionRequest.class, new TypeReference<UpdateEnterpriseConnectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateEnterpriseConnectionRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public UpdateEnterpriseConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateEnterpriseConnectionResponse.Builder resBuilder =
            ...
            UpdateEnterpriseConnectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSchemasEnterpriseConnection(Utils.unmarshal(response, new TypeReference<SchemasEnterpriseConnection>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "403", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
