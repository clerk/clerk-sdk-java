...
public class GetSignUp {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetSignUpRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSignUpRequest, GetSignUpResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetSignUpRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSignUpRequest request) throws Exception {
        ...
        @Override
        public GetSignUpResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSignUpResponse.Builder resBuilder =
                    GetSignUpResponse
                            .builder()
            ...
            GetSignUpResponse res = resBuilder.build();
