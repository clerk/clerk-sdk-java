...
public class VerifyTOTPOperation implements RequestOperation<VerifyTOTPRequest, VerifyTOTPResponse> {
    ...
    public HttpRequest buildRequest(VerifyTOTPRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VerifyTOTPRequest request) throws Exception {
    ...
    @Override
    public VerifyTOTPResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VerifyTOTPResponse.Builder resBuilder = 
            VerifyTOTPResponse
                .builder()
        ...
        VerifyTOTPResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VerifyTOTPResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
