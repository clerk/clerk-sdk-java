...
public class CreateSessionTokenOperation implements RequestOperation<CreateSessionTokenRequest, CreateSessionTokenResponse> {
    ...
    public CreateSessionTokenOperation(
    ...
    public HttpRequest buildRequest(CreateSessionTokenRequest request) throws Exception {
