...
public class ListOrganizationMemberships {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListOrganizationMembershipsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationMembershipsRequest, ListOrganizationMembershipsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListOrganizationMembershipsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationMembershipsRequest request) throws Exception {
        ...
        @Override
        public ListOrganizationMembershipsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationMembershipsResponse.Builder resBuilder =
            ...
            ListOrganizationMembershipsResponse res = resBuilder.build();
