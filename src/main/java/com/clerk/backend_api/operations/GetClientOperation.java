...
public class GetClientOperation implements RequestOperation<GetClientRequest, GetClientResponse> {
    ...
    public HttpRequest buildRequest(GetClientRequest request) throws Exception {
