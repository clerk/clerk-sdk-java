...
public class VerifyOrganizationDomainOwnership {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "VerifyOrganizationDomainOwnership",
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyOrganizationDomainOwnershipRequest, VerifyOrganizationDomainOwnershipResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VerifyOrganizationDomainOwnershipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VerifyOrganizationDomainOwnershipRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyOrganizationDomainOwnershipRequest request) {
        ...
        @Override
        public VerifyOrganizationDomainOwnershipResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyOrganizationDomainOwnershipResponse.Builder resBuilder =
            ...
            VerifyOrganizationDomainOwnershipResponse res = resBuilder.build();
