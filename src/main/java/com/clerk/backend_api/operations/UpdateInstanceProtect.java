...
public class UpdateInstanceProtect {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends UpdateInstanceProtectRequestBody>, UpdateInstanceProtectResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends UpdateInstanceProtectRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends UpdateInstanceProtectRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceProtectRequestBody> request) {
        ...
        @Override
        public UpdateInstanceProtectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateInstanceProtectResponse.Builder resBuilder =
                    UpdateInstanceProtectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateInstanceProtectResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInstanceProtect(Utils.unmarshal(response, new TypeReference<InstanceProtect>() {}));
                } else {
