...
public class CreateBulkInvitations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends List<RequestBody>> request) {
        ...
        @Override
        public CreateBulkInvitationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvitationList(Utils.unmarshal(response, new TypeReference<List<Invitation>>() {}));
                } else {
