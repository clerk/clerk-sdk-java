...
public class CreateBulkInvitations {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends List<RequestBody>>, CreateBulkInvitationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends List<RequestBody>> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends List<RequestBody>>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends List<RequestBody>> request) throws Exception {
        ...
        @Override
        public CreateBulkInvitationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBulkInvitationsResponse.Builder resBuilder =
            ...
            CreateBulkInvitationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Invitation> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInvitationList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
