...
public class ListRedirectURLsOperation implements RequestOperation<ListRedirectURLsRequest, ListRedirectURLsResponse> {
    ...
    public ListRedirectURLsOperation(
    ...
    public HttpRequest buildRequest(ListRedirectURLsRequest request) throws Exception {
