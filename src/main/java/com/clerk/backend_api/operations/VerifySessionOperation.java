...
public class VerifySessionOperation implements RequestOperation<VerifySessionRequest, VerifySessionResponse> {
    ...
    public HttpRequest buildRequest(VerifySessionRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VerifySessionRequest request) throws Exception {
    ...
    @Override
    public VerifySessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VerifySessionResponse.Builder resBuilder = 
        ...
        VerifySessionResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "404", "410")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
