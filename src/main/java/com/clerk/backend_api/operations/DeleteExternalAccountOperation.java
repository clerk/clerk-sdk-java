...
public class DeleteExternalAccountOperation implements RequestOperation<DeleteExternalAccountRequest, DeleteExternalAccountResponse> {
    ...
    public DeleteExternalAccountOperation(
    ...
    public HttpRequest buildRequest(DeleteExternalAccountRequest request) throws Exception {
