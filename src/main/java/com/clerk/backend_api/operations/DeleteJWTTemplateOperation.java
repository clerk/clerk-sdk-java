...
public class DeleteJWTTemplateOperation implements RequestOperation<DeleteJWTTemplateRequest, DeleteJWTTemplateResponse> {
    ...
    public DeleteJWTTemplateOperation(
    ...
    public HttpRequest buildRequest(DeleteJWTTemplateRequest request) throws Exception {
