...
public class VerifyPassword {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyPasswordRequest, VerifyPasswordResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyPasswordRequest request) {
        ...
        @Override
        public VerifyPasswordResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<VerifyPasswordResponseBody>() {}));
                } else {
