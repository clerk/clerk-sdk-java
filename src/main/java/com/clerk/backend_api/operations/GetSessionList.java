...
public class GetSessionList {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionListRequest, GetSessionListResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSessionListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionListRequest request) {
        ...
        @Override
        public GetSessionListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSessionListResponse.Builder resBuilder =
            ...
            GetSessionListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionList(Utils.unmarshal(response, new TypeReference<List<Session>>() {}));
                } else {
