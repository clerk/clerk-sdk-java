...
public class CreateSvixApp {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CreateSvixAppResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public CreateSvixAppResponse handleResponse(HttpResponse<InputStream> response) {
