...
public class ListSAMLConnectionsOperation implements RequestOperation<ListSAMLConnectionsRequest, ListSAMLConnectionsResponse> {
    ...
    public ListSAMLConnectionsOperation(
    ...
    public HttpRequest buildRequest(ListSAMLConnectionsRequest request) throws Exception {
