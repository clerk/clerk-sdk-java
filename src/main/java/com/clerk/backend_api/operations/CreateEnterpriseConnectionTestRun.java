...
public class CreateEnterpriseConnectionTestRun {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateEnterpriseConnectionTestRunRequest, CreateEnterpriseConnectionTestRunResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateEnterpriseConnectionTestRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateEnterpriseConnectionTestRunRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateEnterpriseConnectionTestRunRequest request) {
        ...
        @Override
        public CreateEnterpriseConnectionTestRunResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateEnterpriseConnectionTestRunResponse.Builder resBuilder =
            ...
            CreateEnterpriseConnectionTestRunResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnterpriseConnectionTestRunResponse(Utils.unmarshal(response, new TypeReference<EnterpriseConnectionTestRunResponse>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "402", "403", "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
