...
import com.clerk.backend_api.models.operations.VerifyOAuthAccessTokenResponseBody;
...
public class VerifyOAuthAccessToken {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VerifyOAuthAccessTokenRequestBody request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<VerifyOAuthAccessTokenRequestBody>() {
                    });
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyOAuthAccessTokenRequestBody, VerifyOAuthAccessTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(VerifyOAuthAccessTokenRequestBody request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyOAuthAccessTokenRequestBody request) throws Exception {
        ...
        @Override
        public VerifyOAuthAccessTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyOAuthAccessTokenResponse.Builder resBuilder =
            ...
            VerifyOAuthAccessTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    VerifyOAuthAccessTokenResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.clerk.backend_api.models.errors.VerifyOAuthAccessTokenResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    VerifyOAuthAccessTokenOauthAccessTokensResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
