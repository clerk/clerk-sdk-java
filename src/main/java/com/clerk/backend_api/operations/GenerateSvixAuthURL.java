...
public class GenerateSvixAuthURL {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GenerateSvixAuthURLResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GenerateSvixAuthURLResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSvixURL(Utils.unmarshal(response, new TypeReference<SvixURL>() {}));
                } else {
