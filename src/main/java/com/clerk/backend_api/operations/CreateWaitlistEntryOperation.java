...
public class CreateWaitlistEntryOperation implements RequestOperation<Optional<? extends CreateWaitlistEntryRequestBody>, CreateWaitlistEntryResponse> {
    ...
    public CreateWaitlistEntryOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateWaitlistEntryRequestBody> request) throws Exception {
