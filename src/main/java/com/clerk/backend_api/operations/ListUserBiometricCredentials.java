...
public class ListUserBiometricCredentials {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUserBiometricCredentialsRequest, ListUserBiometricCredentialsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListUserBiometricCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUserBiometricCredentialsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUserBiometricCredentialsRequest request) {
        ...
        @Override
        public ListUserBiometricCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUserBiometricCredentialsResponse.Builder resBuilder =
            ...
            ListUserBiometricCredentialsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBiometricCredentialList(Utils.unmarshal(response, new TypeReference<BiometricCredentialList>() {}));
                } else {
