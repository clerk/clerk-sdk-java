...
public class GetSessionListOperation implements RequestOperation<GetSessionListRequest, GetSessionListResponse> {
    ...
    public GetSessionListOperation(
    ...
    public HttpRequest buildRequest(GetSessionListRequest request) throws Exception {
