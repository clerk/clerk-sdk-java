...
public class ListOrganizations {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListOrganizationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationsRequest, ListOrganizationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListOrganizationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationsRequest request) throws Exception {
        ...
        @Override
        public ListOrganizationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationsResponse.Builder resBuilder =
            ...
            ListOrganizationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Organizations out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
