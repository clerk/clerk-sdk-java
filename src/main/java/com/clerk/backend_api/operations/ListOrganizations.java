...
public class ListOrganizations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationsRequest request) {
        ...
        @Override
        public ListOrganizationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizations(Utils.unmarshal(response, new TypeReference<Organizations>() {}));
                } else {
