...
public class ListOrganizationRoles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationRolesRequest, ListOrganizationRolesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListOrganizationRolesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListOrganizationRolesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationRolesRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "422", "4XX", "5XX")) {
        ...
        @Override
        public ListOrganizationRolesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationRolesResponse.Builder resBuilder =
            ...
            ListOrganizationRolesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoles(Utils.unmarshal(response, new TypeReference<Roles>() {}));
                } else {
