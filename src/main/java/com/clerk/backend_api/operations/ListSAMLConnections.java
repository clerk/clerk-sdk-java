...
public class ListSAMLConnections {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSAMLConnectionsRequest request) {
        ...
        @Override
        public ListSAMLConnectionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSAMLConnections(Utils.unmarshal(response, new TypeReference<SAMLConnections>() {}));
                } else {
