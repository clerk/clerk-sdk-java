...
public class ListSAMLConnections {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListSAMLConnectionsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSAMLConnectionsRequest, ListSAMLConnectionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListSAMLConnectionsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSAMLConnectionsRequest request) throws Exception {
        ...
        @Override
        public ListSAMLConnectionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSAMLConnectionsResponse.Builder resBuilder =
            ...
            ListSAMLConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SAMLConnections out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSAMLConnections(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
