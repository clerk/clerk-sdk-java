...
public class ListInvitationsOperation implements RequestOperation<ListInvitationsRequest, ListInvitationsResponse> {
    ...
    public ListInvitationsOperation(
    ...
    public HttpRequest buildRequest(ListInvitationsRequest request) throws Exception {
