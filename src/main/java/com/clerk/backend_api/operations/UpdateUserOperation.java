...
public class UpdateUserOperation implements RequestOperation<UpdateUserRequest, UpdateUserResponse> {
    ...
    public HttpRequest buildRequest(UpdateUserRequest request) throws Exception {
