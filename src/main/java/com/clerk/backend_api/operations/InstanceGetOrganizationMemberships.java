...
public class InstanceGetOrganizationMemberships {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(InstanceGetOrganizationMembershipsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<InstanceGetOrganizationMembershipsRequest, InstanceGetOrganizationMembershipsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(InstanceGetOrganizationMembershipsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InstanceGetOrganizationMembershipsRequest request) throws Exception {
        ...
        @Override
        public InstanceGetOrganizationMembershipsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            InstanceGetOrganizationMembershipsResponse.Builder resBuilder =
            ...
            InstanceGetOrganizationMembershipsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationMemberships out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationMemberships(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
