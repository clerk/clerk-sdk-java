...
public class InstanceGetOrganizationMemberships {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InstanceGetOrganizationMembershipsRequest request) {
        ...
        @Override
        public InstanceGetOrganizationMembershipsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationMemberships(Utils.unmarshal(response, new TypeReference<OrganizationMemberships>() {}));
                } else {
