...
public class CreateMachineScope {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMachineScopeRequest request) {
        ...
        @Override
        public CreateMachineScopeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMachineScope(Utils.unmarshal(response, new TypeReference<MachineScope>() {}));
                } else {
