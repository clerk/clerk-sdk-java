...
public class RevokeActorToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeActorTokenRequest request) {
        ...
        @Override
        public RevokeActorTokenResponse handleResponse(HttpResponse<InputStream> response) {
