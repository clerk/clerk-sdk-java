...
public class CreateOrganizationPermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrganizationPermissionRequestBody, CreateOrganizationPermissionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateOrganizationPermissionRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateOrganizationPermissionRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrganizationPermissionRequestBody request) {
        ...
        @Override
        public CreateOrganizationPermissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOrganizationPermissionResponse.Builder resBuilder =
            ...
            CreateOrganizationPermissionResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "402", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
