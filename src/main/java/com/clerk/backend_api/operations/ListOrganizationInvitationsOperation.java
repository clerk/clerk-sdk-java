...
public class ListOrganizationInvitationsOperation implements RequestOperation<ListOrganizationInvitationsRequest, ListOrganizationInvitationsResponse> {
    ...
    public ListOrganizationInvitationsOperation(
    ...
    public HttpRequest buildRequest(ListOrganizationInvitationsRequest request) throws Exception {
