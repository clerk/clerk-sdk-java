...
public class ListOrganizationDomains {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListOrganizationDomainsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationDomainsRequest, ListOrganizationDomainsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListOrganizationDomainsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationDomainsRequest request) throws Exception {
        ...
        @Override
        public ListOrganizationDomainsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationDomainsResponse.Builder resBuilder =
            ...
            ListOrganizationDomainsResponse res = resBuilder.build();
