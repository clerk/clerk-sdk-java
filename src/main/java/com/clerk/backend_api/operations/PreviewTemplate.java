...
public class PreviewTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<PreviewTemplateRequest, PreviewTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PreviewTemplateRequest request) {
        ...
        @Override
        public PreviewTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<PreviewTemplateResponseBody>() {}));
                } else {
