...
public class GetClient {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetClientRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClientRequest, GetClientResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetClientRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClientRequest request) throws Exception {
        ...
        @Override
        public GetClientResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClientResponse.Builder resBuilder =
                    GetClientResponse
                            .builder()
            ...
            GetClientResponse res = resBuilder.build();
