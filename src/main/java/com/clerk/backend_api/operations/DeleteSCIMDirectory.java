...
public class DeleteSCIMDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSCIMDirectoryRequest, DeleteSCIMDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSCIMDirectoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSCIMDirectoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSCIMDirectoryRequest request) {
        ...
        @Override
        public DeleteSCIMDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSCIMDirectoryResponse.Builder resBuilder =
            ...
            DeleteSCIMDirectoryResponse res = resBuilder.build();
