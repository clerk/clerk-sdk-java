...
public class ReplaceUserMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceUserMetadataRequest, ReplaceUserMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceUserMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceUserMetadataRequest.class, new TypeReference<ReplaceUserMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceUserMetadataRequest request) {
        ...
        @Override
        public ReplaceUserMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceUserMetadataResponse.Builder resBuilder =
            ...
            ReplaceUserMetadataResponse res = resBuilder.build();
