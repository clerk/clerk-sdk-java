...
public class UploadOrganizationLogoOperation implements RequestOperation<UploadOrganizationLogoRequest, UploadOrganizationLogoResponse> {
    ...
    public UploadOrganizationLogoOperation(
    ...
    public HttpRequest buildRequest(UploadOrganizationLogoRequest request) throws Exception {
