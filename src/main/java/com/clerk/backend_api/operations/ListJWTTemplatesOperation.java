...
public class ListJWTTemplatesOperation implements RequestOperation<ListJWTTemplatesRequest, ListJWTTemplatesResponse> {
    ...
    public ListJWTTemplatesOperation(
    ...
    public HttpRequest buildRequest(ListJWTTemplatesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListJWTTemplatesRequest request) throws Exception {
    ...
    @Override
    public ListJWTTemplatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListJWTTemplatesResponse.Builder resBuilder = 
        ...
        ListJWTTemplatesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<JWTTemplate> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withJWTTemplateList(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
