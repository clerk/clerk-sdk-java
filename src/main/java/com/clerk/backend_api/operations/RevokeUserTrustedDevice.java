...
public class RevokeUserTrustedDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeUserTrustedDeviceRequest, RevokeUserTrustedDeviceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeUserTrustedDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeUserTrustedDeviceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeUserTrustedDeviceRequest request) {
        ...
        @Override
        public RevokeUserTrustedDeviceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeUserTrustedDeviceResponse.Builder resBuilder =
                    RevokeUserTrustedDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            RevokeUserTrustedDeviceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTrustedDevice(Utils.unmarshal(response, new TypeReference<TrustedDevice>() {}));
                } else {
