...
public class DeleteAWSCredential {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteAWSCredentialRequest request) throws Exception {
            String url = Utils.generateURL(
                    DeleteAWSCredentialRequest.class,
                    this.baseUrl,
                    "/aws_credentials/{id}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAWSCredentialRequest, DeleteAWSCredentialResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeleteAWSCredentialRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAWSCredentialRequest request) throws Exception {
        ...
        @Override
        public DeleteAWSCredentialResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteAWSCredentialResponse.Builder resBuilder =
            ...
            DeleteAWSCredentialResponse res = resBuilder.build();
