...
public class RefreshSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSessionRequest, RefreshSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RefreshSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSessionRequest.class, new TypeReference<RefreshSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSessionRequest request) throws Exception {
        ...
        @Override
        public RefreshSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSessionResponse.Builder resBuilder =
            ...
            RefreshSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SessionRefresh out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSessionRefresh(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
