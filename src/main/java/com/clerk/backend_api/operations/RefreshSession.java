...
public class RefreshSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSessionRequest request) {
        ...
        @Override
        public RefreshSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionRefresh(Utils.unmarshal(response, new TypeReference<SessionRefresh>() {}));
                } else {
