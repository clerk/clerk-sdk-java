...
public class RevokeSessionOperation implements RequestOperation<RevokeSessionRequest, RevokeSessionResponse> {
    ...
    public HttpRequest buildRequest(RevokeSessionRequest request) throws Exception {
