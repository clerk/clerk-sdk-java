...
public class UpdateInstanceOrganizationSettings {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends UpdateInstanceOrganizationSettingsRequestBody>, UpdateInstanceOrganizationSettingsResponse> {
            ...
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "404", "422", "4XX", "5XX")) {
