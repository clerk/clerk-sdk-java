...
public class UpdateInstanceOrganizationSettings {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceOrganizationSettingsRequestBody> request) {
        ...
        @Override
        public UpdateInstanceOrganizationSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationSettings(Utils.unmarshal(response, new TypeReference<OrganizationSettings>() {}));
                } else {
