...
public class RotateDirectoryAPIKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<RotateDirectoryAPIKeyRequest, RotateDirectoryAPIKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RotateDirectoryAPIKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RotateDirectoryAPIKeyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RotateDirectoryAPIKeyRequest request) {
        ...
        @Override
        public RotateDirectoryAPIKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RotateDirectoryAPIKeyResponse.Builder resBuilder =
            ...
            RotateDirectoryAPIKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDirectory(Utils.unmarshal(response, new TypeReference<Directory>() {}));
                } else {
