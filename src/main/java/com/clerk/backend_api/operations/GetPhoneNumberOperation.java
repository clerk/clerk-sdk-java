...
public class GetPhoneNumberOperation implements RequestOperation<GetPhoneNumberRequest, GetPhoneNumberResponse> {
    ...
    public GetPhoneNumberOperation(
    ...
    public HttpRequest buildRequest(GetPhoneNumberRequest request) throws Exception {
