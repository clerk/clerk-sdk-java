...
public class UpdateOrganizationOperation implements RequestOperation<UpdateOrganizationRequest, UpdateOrganizationResponse> {
    ...
    public HttpRequest buildRequest(UpdateOrganizationRequest request) throws Exception {
