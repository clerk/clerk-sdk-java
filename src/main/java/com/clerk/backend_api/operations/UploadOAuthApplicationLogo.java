...
public class UploadOAuthApplicationLogo {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadOAuthApplicationLogoRequest, UploadOAuthApplicationLogoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadOAuthApplicationLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadOAuthApplicationLogoRequest.class, new TypeReference<UploadOAuthApplicationLogoRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadOAuthApplicationLogoRequest request) {
        ...
        @Override
        public UploadOAuthApplicationLogoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadOAuthApplicationLogoResponse.Builder resBuilder =
            ...
            UploadOAuthApplicationLogoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOAuthApplication(Utils.unmarshal(response, new TypeReference<OAuthApplication>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "403", "404", "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
