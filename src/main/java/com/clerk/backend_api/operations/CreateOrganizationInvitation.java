...
public class CreateOrganizationInvitation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrganizationInvitationRequest, CreateOrganizationInvitationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateOrganizationInvitationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrganizationInvitationRequest.class, new TypeReference<CreateOrganizationInvitationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrganizationInvitationRequest request) {
        ...
        @Override
        public CreateOrganizationInvitationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOrganizationInvitationResponse.Builder resBuilder =
            ...
            CreateOrganizationInvitationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationInvitation(Utils.unmarshal(response, new TypeReference<OrganizationInvitation>() {}));
                } else {
