...
public class DeleteTOTPOperation implements RequestOperation<DeleteTOTPRequest, DeleteTOTPResponse> {
    ...
    public HttpRequest buildRequest(DeleteTOTPRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeleteTOTPRequest request) throws Exception {
    ...
    @Override
    public DeleteTOTPResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeleteTOTPResponse.Builder resBuilder = 
            DeleteTOTPResponse
                .builder()
        ...
        DeleteTOTPResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeleteTOTPResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
