...
public class ListAllowlistIdentifiers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllowlistIdentifiersRequest request) {
        ...
        @Override
        public ListAllowlistIdentifiersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAllowlistIdentifierList(Utils.unmarshal(response, new TypeReference<List<AllowlistIdentifier>>() {}));
                } else {
