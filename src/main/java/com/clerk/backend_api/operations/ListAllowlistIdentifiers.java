...
public class ListAllowlistIdentifiers {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListAllowlistIdentifiersRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllowlistIdentifiersRequest, ListAllowlistIdentifiersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListAllowlistIdentifiersRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllowlistIdentifiersRequest request) throws Exception {
        ...
        @Override
        public ListAllowlistIdentifiersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllowlistIdentifiersResponse.Builder resBuilder =
            ...
            ListAllowlistIdentifiersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AllowlistIdentifier> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAllowlistIdentifierList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
