...
public class UpdateOAuthApplicationOperation implements RequestOperation<UpdateOAuthApplicationRequest, UpdateOAuthApplicationResponse> {
    ...
    public UpdateOAuthApplicationOperation(
    ...
    public HttpRequest buildRequest(UpdateOAuthApplicationRequest request) throws Exception {
