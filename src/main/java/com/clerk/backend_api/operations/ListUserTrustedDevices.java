...
public class ListUserTrustedDevices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUserTrustedDevicesRequest, ListUserTrustedDevicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListUserTrustedDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUserTrustedDevicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUserTrustedDevicesRequest request) {
        ...
        @Override
        public ListUserTrustedDevicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUserTrustedDevicesResponse.Builder resBuilder =
            ...
            ListUserTrustedDevicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTrustedDeviceList(Utils.unmarshal(response, new TypeReference<TrustedDeviceList>() {}));
                } else {
