...
public class ListEnterpriseConnections {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEnterpriseConnectionsRequest, ListEnterpriseConnectionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListEnterpriseConnectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnterpriseConnectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnterpriseConnectionsRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "402", "403", "422", "4XX", "5XX")) {
        ...
        @Override
        public ListEnterpriseConnectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEnterpriseConnectionsResponse.Builder resBuilder =
            ...
            ListEnterpriseConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnterpriseConnections(Utils.unmarshal(response, new TypeReference<EnterpriseConnections>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "402", "403", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
