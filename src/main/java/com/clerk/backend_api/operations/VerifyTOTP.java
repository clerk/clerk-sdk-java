...
public class VerifyTOTP {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyTOTPRequest, VerifyTOTPResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyTOTPRequest request) {
        ...
        @Override
        public VerifyTOTPResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<VerifyTOTPResponseBody>() {}));
                } else {
