...
public class UpdateRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRoleSetRequest, UpdateRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateRoleSetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRoleSetRequest.class, new TypeReference<UpdateRoleSetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRoleSetRequest request) {
        ...
        @Override
        public UpdateRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRoleSetResponse.Builder resBuilder =
            ...
            UpdateRoleSetResponse res = resBuilder.build();
