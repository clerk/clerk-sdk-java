...
public class DeleteSCIMGroupRoleMapping {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSCIMGroupRoleMappingRequest, DeleteSCIMGroupRoleMappingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSCIMGroupRoleMappingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSCIMGroupRoleMappingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSCIMGroupRoleMappingRequest request) {
        ...
        @Override
        public DeleteSCIMGroupRoleMappingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSCIMGroupRoleMappingResponse.Builder resBuilder =
            ...
            DeleteSCIMGroupRoleMappingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSCIMGroupRoleMappingDeleted(Utils.unmarshal(response, new TypeReference<SCIMGroupRoleMappingDeleted>() {}));
                } else {
