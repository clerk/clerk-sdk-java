...
public class CreateSignInToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateSignInTokenRequestBody>, CreateSignInTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends CreateSignInTokenRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateSignInTokenRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateSignInTokenRequestBody> request) {
        ...
        @Override
        public CreateSignInTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSignInToken(Utils.unmarshal(response, new TypeReference<SignInToken>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "403", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
