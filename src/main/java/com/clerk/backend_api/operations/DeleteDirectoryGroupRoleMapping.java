...
public class DeleteDirectoryGroupRoleMapping {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "DeleteDirectoryGroupRoleMapping",
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDirectoryGroupRoleMappingRequest, DeleteDirectoryGroupRoleMappingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteDirectoryGroupRoleMappingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDirectoryGroupRoleMappingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDirectoryGroupRoleMappingRequest request) {
        ...
        @Override
        public DeleteDirectoryGroupRoleMappingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDirectoryGroupRoleMappingResponse.Builder resBuilder =
            ...
            DeleteDirectoryGroupRoleMappingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDirectoryGroupRoleMappingDeleted(Utils.unmarshal(response, new TypeReference<DirectoryGroupRoleMappingDeleted>() {}));
                } else {
