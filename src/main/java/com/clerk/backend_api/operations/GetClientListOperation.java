...
public class GetClientListOperation implements RequestOperation<GetClientListRequest, GetClientListResponse> {
    ...
    public HttpRequest buildRequest(GetClientListRequest request) throws Exception {
