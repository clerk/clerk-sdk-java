...
public class ListMachines {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListMachinesRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMachinesRequest, ListMachinesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListMachinesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMachinesRequest request) throws Exception {
        ...
        @Override
        public ListMachinesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMachinesResponse.Builder resBuilder =
            ...
            ListMachinesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MachineList out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMachineList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
