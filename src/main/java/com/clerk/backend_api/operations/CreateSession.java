...
public class CreateSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateSessionRequestBody>, CreateSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateSessionRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateSessionRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateSessionRequestBody> request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public CreateSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
