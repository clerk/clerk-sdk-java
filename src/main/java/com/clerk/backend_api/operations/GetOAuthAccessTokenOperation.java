...
public class GetOAuthAccessTokenOperation implements RequestOperation<GetOAuthAccessTokenRequest, GetOAuthAccessTokenResponse> {
    ...
    public GetOAuthAccessTokenOperation(
    ...
    public HttpRequest buildRequest(GetOAuthAccessTokenRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetOAuthAccessTokenRequest request) throws Exception {
    ...
    @Override
    public GetOAuthAccessTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetOAuthAccessTokenResponse.Builder resBuilder = 
        ...
        GetOAuthAccessTokenResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<OAuthAccessToken> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withOAuthAccessToken(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
