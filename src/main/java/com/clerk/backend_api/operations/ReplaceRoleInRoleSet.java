...
public class ReplaceRoleInRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceRoleInRoleSetRequest, ReplaceRoleInRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceRoleInRoleSetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceRoleInRoleSetRequest.class, new TypeReference<ReplaceRoleInRoleSetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceRoleInRoleSetRequest request) {
        ...
        @Override
        public ReplaceRoleInRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceRoleInRoleSetResponse.Builder resBuilder =
            ...
            ReplaceRoleInRoleSetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoleSet(Utils.unmarshal(response, new TypeReference<RoleSet>() {}));
                } else {
