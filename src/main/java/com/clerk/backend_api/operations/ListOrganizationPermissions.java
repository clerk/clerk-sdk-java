...
public class ListOrganizationPermissions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOrganizationPermissionsRequest, ListOrganizationPermissionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListOrganizationPermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListOrganizationPermissionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOrganizationPermissionsRequest request) {
        ...
        @Override
        public ListOrganizationPermissionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOrganizationPermissionsResponse.Builder resBuilder =
                    ListOrganizationPermissionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListOrganizationPermissionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPermissions(Utils.unmarshal(response, new TypeReference<Permissions>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
