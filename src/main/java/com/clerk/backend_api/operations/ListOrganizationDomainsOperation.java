...
public class ListOrganizationDomainsOperation implements RequestOperation<ListOrganizationDomainsRequest, ListOrganizationDomainsResponse> {
    ...
    public ListOrganizationDomainsOperation(
    ...
    public HttpRequest buildRequest(ListOrganizationDomainsRequest request) throws Exception {
