...
public class CreateSessionOperation implements RequestOperation<Optional<? extends CreateSessionRequestBody>, CreateSessionResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends CreateSessionRequestBody> request) throws Exception {
