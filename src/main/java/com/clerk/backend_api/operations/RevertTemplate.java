...
public class RevertTemplate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevertTemplateRequest request) {
        ...
        @Override
        public RevertTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTemplate(Utils.unmarshal(response, new TypeReference<Template>() {}));
                } else {
