...
public class RevertTemplate {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(RevertTemplateRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevertTemplateRequest, RevertTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevertTemplateRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevertTemplateRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "402", "404", "4XX", "5XX")) {
        ...
        @Override
        public RevertTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevertTemplateResponse.Builder resBuilder =
            ...
            RevertTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Template out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTemplate(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "402", "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
