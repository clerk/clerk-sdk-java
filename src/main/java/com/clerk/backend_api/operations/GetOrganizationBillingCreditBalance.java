...
public class GetOrganizationBillingCreditBalance {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "GetOrganizationBillingCreditBalance",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrganizationBillingCreditBalanceRequest, GetOrganizationBillingCreditBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOrganizationBillingCreditBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationBillingCreditBalanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrganizationBillingCreditBalanceRequest request) {
        ...
        @Override
        public GetOrganizationBillingCreditBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrganizationBillingCreditBalanceResponse.Builder resBuilder =
            ...
            GetOrganizationBillingCreditBalanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceCreditBalanceResponse(Utils.unmarshal(response, new TypeReference<CommerceCreditBalanceResponse>() {}));
                } else {
