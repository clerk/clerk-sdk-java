...
public class ListRoleSets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRoleSetsRequest, ListRoleSetsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListRoleSetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRoleSetsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRoleSetsRequest request) {
        ...
        @Override
        public ListRoleSetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRoleSetsResponse.Builder resBuilder =
            ...
            ListRoleSetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoleSets(Utils.unmarshal(response, new TypeReference<RoleSets>() {}));
                } else {
