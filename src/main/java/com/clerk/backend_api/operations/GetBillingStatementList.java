...
public class GetBillingStatementList {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBillingStatementListRequest, GetBillingStatementListResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBillingStatementListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBillingStatementListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBillingStatementListRequest request) {
        ...
        @Override
        public GetBillingStatementListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBillingStatementListResponse.Builder resBuilder =
            ...
            GetBillingStatementListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedBillingStatementResponse(Utils.unmarshal(response, new TypeReference<PaginatedBillingStatementResponse>() {}));
                } else {
