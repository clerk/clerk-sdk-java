...
import com.clerk.backend_api.models.components.Role;
...
public class RemovePermissionFromOrganizationRole {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePermissionFromOrganizationRoleRequest, RemovePermissionFromOrganizationRoleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemovePermissionFromOrganizationRoleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePermissionFromOrganizationRoleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePermissionFromOrganizationRoleRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public RemovePermissionFromOrganizationRoleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePermissionFromOrganizationRoleResponse.Builder resBuilder =
            ...
            RemovePermissionFromOrganizationRoleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRole(Utils.unmarshal(response, new TypeReference<Role>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
