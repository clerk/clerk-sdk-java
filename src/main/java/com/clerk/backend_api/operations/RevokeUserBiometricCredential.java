...
public class RevokeUserBiometricCredential {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeUserBiometricCredentialRequest, RevokeUserBiometricCredentialResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeUserBiometricCredentialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeUserBiometricCredentialRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeUserBiometricCredentialRequest request) {
        ...
        @Override
        public RevokeUserBiometricCredentialResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeUserBiometricCredentialResponse.Builder resBuilder =
            ...
            RevokeUserBiometricCredentialResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBiometricCredential(Utils.unmarshal(response, new TypeReference<BiometricCredential>() {}));
                } else {
