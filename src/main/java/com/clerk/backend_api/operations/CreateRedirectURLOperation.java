...
public class CreateRedirectURLOperation implements RequestOperation<Optional<? extends CreateRedirectURLRequestBody>, CreateRedirectURLResponse> {
    ...
    public CreateRedirectURLOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateRedirectURLRequestBody> request) throws Exception {
