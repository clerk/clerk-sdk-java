...
public class GetPhoneNumber {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetPhoneNumberRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPhoneNumberRequest, GetPhoneNumberResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetPhoneNumberRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPhoneNumberRequest request) throws Exception {
        ...
        @Override
        public GetPhoneNumberResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPhoneNumberResponse.Builder resBuilder =
            ...
            GetPhoneNumberResponse res = resBuilder.build();
