...
public class DeleteSAMLConnectionOperation implements RequestOperation<DeleteSAMLConnectionRequest, DeleteSAMLConnectionResponse> {
    ...
    public DeleteSAMLConnectionOperation(
    ...
    public HttpRequest buildRequest(DeleteSAMLConnectionRequest request) throws Exception {
