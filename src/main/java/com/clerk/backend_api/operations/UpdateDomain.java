...
public class UpdateDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDomainRequest, UpdateDomainResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDomainRequest.class, new TypeReference<UpdateDomainRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDomainRequest request) {
        ...
        @Override
        public UpdateDomainResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDomainResponse.Builder resBuilder =
            ...
            UpdateDomainResponse res = resBuilder.build();
