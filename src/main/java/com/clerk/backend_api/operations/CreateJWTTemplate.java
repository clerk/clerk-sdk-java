...
public class CreateJWTTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateJWTTemplateRequestBody>, CreateJWTTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateJWTTemplateRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateJWTTemplateRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateJWTTemplateRequestBody> request) throws Exception {
        ...
        @Override
        public CreateJWTTemplateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateJWTTemplateResponse.Builder resBuilder =
            ...
            CreateJWTTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    JWTTemplate out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withJWTTemplate(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
