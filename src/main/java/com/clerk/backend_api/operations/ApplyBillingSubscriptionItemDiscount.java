...
public class ApplyBillingSubscriptionItemDiscount {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "ApplyBillingSubscriptionItemDiscount",
    ...
    public static class Sync extends Base
            implements RequestOperation<ApplyBillingSubscriptionItemDiscountRequest, ApplyBillingSubscriptionItemDiscountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ApplyBillingSubscriptionItemDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ApplyBillingSubscriptionItemDiscountRequest.class, new TypeReference<ApplyBillingSubscriptionItemDiscountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ApplyBillingSubscriptionItemDiscountRequest request) {
        ...
        @Override
        public ApplyBillingSubscriptionItemDiscountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ApplyBillingSubscriptionItemDiscountResponse.Builder resBuilder =
            ...
            ApplyBillingSubscriptionItemDiscountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceDiscountRedemptionResponse(Utils.unmarshal(response, new TypeReference<CommerceDiscountRedemptionResponse>() {}));
                } else {
