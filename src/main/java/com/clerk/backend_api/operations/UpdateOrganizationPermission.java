...
public class UpdateOrganizationPermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateOrganizationPermissionRequest, UpdateOrganizationPermissionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateOrganizationPermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateOrganizationPermissionRequest.class, new TypeReference<UpdateOrganizationPermissionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateOrganizationPermissionRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public UpdateOrganizationPermissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateOrganizationPermissionResponse.Builder resBuilder =
            ...
            UpdateOrganizationPermissionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPermission(Utils.unmarshal(response, new TypeReference<Permission>() {}));
                } else {
