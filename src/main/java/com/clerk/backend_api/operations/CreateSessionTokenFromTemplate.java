...
public class CreateSessionTokenFromTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSessionTokenFromTemplateRequest, CreateSessionTokenFromTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSessionTokenFromTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSessionTokenFromTemplateRequest.class, new TypeReference<CreateSessionTokenFromTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSessionTokenFromTemplateRequest request) {
        ...
        @Override
        public CreateSessionTokenFromTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSessionTokenFromTemplateResponse.Builder resBuilder =
            ...
            CreateSessionTokenFromTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateSessionTokenFromTemplateResponseBody>() {}));
                } else {
