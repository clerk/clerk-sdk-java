...
public class CreateInvitation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateInvitationRequestBody> request) {
        ...
        @Override
        public CreateInvitationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvitation(Utils.unmarshal(response, new TypeReference<Invitation>() {}));
                } else {
