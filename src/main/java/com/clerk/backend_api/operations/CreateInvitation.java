...
public class CreateInvitation {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateInvitationRequestBody>, CreateInvitationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateInvitationRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateInvitationRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateInvitationRequestBody> request) throws Exception {
        ...
        @Override
        public CreateInvitationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateInvitationResponse.Builder resBuilder =
            ...
            CreateInvitationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Invitation out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInvitation(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
