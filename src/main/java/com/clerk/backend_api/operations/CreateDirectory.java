...
public class CreateDirectory {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateDirectoryRequestBody>, CreateDirectoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Optional<? extends CreateDirectoryRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateDirectoryRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateDirectoryRequestBody> request) {
        ...
        @Override
        public CreateDirectoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDirectoryResponse.Builder resBuilder =
            ...
            CreateDirectoryResponse res = resBuilder.build();
