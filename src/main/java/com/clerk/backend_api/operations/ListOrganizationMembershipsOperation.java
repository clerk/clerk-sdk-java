...
public class ListOrganizationMembershipsOperation implements RequestOperation<ListOrganizationMembershipsRequest, ListOrganizationMembershipsResponse> {
    ...
    public ListOrganizationMembershipsOperation(
    ...
    public HttpRequest buildRequest(ListOrganizationMembershipsRequest request) throws Exception {
