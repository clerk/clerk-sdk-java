...
public class CreateOrganizationOperation implements RequestOperation<Optional<? extends CreateOrganizationRequestBody>, CreateOrganizationResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends CreateOrganizationRequestBody> request) throws Exception {
