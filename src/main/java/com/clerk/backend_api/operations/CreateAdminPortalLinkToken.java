...
import com.clerk.backend_api.models.errors.CreateAdminPortalLinkTokenAdminPortalLinkTokensResponse409ResponseBody;
import com.clerk.backend_api.models.errors.CreateAdminPortalLinkTokenAdminPortalLinkTokensResponseBody;
import com.clerk.backend_api.models.errors.CreateAdminPortalLinkTokenAdminPortalLinkTokensResponseResponseBody;
...
import com.clerk.backend_api.models.operations.CreateAdminPortalLinkTokenResponseBody;
...
public class CreateAdminPortalLinkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdminPortalLinkTokenRequestBody, CreateAdminPortalLinkTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateAdminPortalLinkTokenRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateAdminPortalLinkTokenRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdminPortalLinkTokenRequestBody request) {
        ...
        @Override
        public CreateAdminPortalLinkTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdminPortalLinkTokenResponse.Builder resBuilder =
            ...
            CreateAdminPortalLinkTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateAdminPortalLinkTokenResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.CreateAdminPortalLinkTokenResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateAdminPortalLinkTokenAdminPortalLinkTokensResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "403")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateAdminPortalLinkTokenAdminPortalLinkTokensResponseResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "409")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateAdminPortalLinkTokenAdminPortalLinkTokensResponse409ResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
