...
public class UsersUnban {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UsersUnbanRequestBody request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<UsersUnbanRequestBody>() {
                    });
    ...
    public static class Sync extends Base
            implements RequestOperation<UsersUnbanRequestBody, UsersUnbanResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UsersUnbanRequestBody request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UsersUnbanRequestBody request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "4XX", "5XX")) {
        ...
        @Override
        public UsersUnbanResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UsersUnbanResponse.Builder resBuilder =
                    UsersUnbanResponse
                            .builder()
            ...
            UsersUnbanResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
