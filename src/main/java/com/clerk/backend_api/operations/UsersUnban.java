...
public class UsersUnban {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UsersUnbanRequestBody request) {
        ...
        @Override
        public UsersUnbanResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserList(Utils.unmarshal(response, new TypeReference<List<User>>() {}));
                } else {
