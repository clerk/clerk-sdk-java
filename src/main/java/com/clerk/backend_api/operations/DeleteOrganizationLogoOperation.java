...
public class DeleteOrganizationLogoOperation implements RequestOperation<DeleteOrganizationLogoRequest, DeleteOrganizationLogoResponse> {
    ...
    public DeleteOrganizationLogoOperation(
    ...
    public HttpRequest buildRequest(DeleteOrganizationLogoRequest request) throws Exception {
