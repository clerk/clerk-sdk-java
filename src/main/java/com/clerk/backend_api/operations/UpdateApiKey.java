...
import com.clerk.backend_api.models.operations.UpdateApiKeyResponseBody;
...
public class UpdateApiKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateApiKeyRequest, UpdateApiKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateApiKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateApiKeyRequest.class, new TypeReference<UpdateApiKeyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateApiKeyRequest request) {
        ...
        @Override
        public UpdateApiKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateApiKeyResponse.Builder resBuilder =
            ...
            UpdateApiKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateApiKeyResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.UpdateApiKeyResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw UpdateAPIKeyAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
