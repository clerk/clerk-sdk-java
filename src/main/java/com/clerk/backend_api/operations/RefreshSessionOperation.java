...
public class RefreshSessionOperation implements RequestOperation<RefreshSessionRequest, RefreshSessionResponse> {
    ...
    public HttpRequest buildRequest(RefreshSessionRequest request) throws Exception {
