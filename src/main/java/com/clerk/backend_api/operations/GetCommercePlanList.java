...
public class GetCommercePlanList {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommercePlanListRequest request) {
        ...
        @Override
        public GetCommercePlanListResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedCommercePlanResponse(Utils.unmarshal(response, new TypeReference<PaginatedCommercePlanResponse>() {}));
                } else {
