...
public class GetCommercePlanList {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetCommercePlanListRequest request) throws Exception {
            ...
            req.addQueryParams(Utils.getQueryParams(
                    GetCommercePlanListRequest.class,
                    request,
                    null));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommercePlanListRequest, GetCommercePlanListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetCommercePlanListRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommercePlanListRequest request) throws Exception {
        ...
        @Override
        public GetCommercePlanListResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommercePlanListResponse.Builder resBuilder =
            ...
            GetCommercePlanListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaginatedCommercePlanResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaginatedCommercePlanResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
