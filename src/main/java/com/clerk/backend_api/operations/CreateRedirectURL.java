...
public class CreateRedirectURL {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateRedirectURLRequestBody>, CreateRedirectURLResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateRedirectURLRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateRedirectURLRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateRedirectURLRequestBody> request) throws Exception {
        ...
        @Override
        public CreateRedirectURLResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRedirectURLResponse.Builder resBuilder =
            ...
            CreateRedirectURLResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RedirectURL out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRedirectURL(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
