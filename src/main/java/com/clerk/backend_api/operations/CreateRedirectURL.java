...
public class CreateRedirectURL {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateRedirectURLRequestBody> request) {
        ...
        @Override
        public CreateRedirectURLResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRedirectURL(Utils.unmarshal(response, new TypeReference<RedirectURL>() {}));
                } else {
