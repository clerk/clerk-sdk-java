...
public class UsersBan {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UsersBanRequestBody request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<UsersBanRequestBody>() {
                    });
    ...
    public static class Sync extends Base
            implements RequestOperation<UsersBanRequestBody, UsersBanResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UsersBanRequestBody request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UsersBanRequestBody request) throws Exception {
        ...
        @Override
        public UsersBanResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UsersBanResponse.Builder resBuilder =
                    UsersBanResponse
                            .builder()
            ...
            UsersBanResponse res = resBuilder.build();
