...
import com.clerk.backend_api.models.operations.VerifyApiKeyResponseBody;
...
public class VerifyApiKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyApiKeyRequestBody, VerifyApiKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VerifyApiKeyRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VerifyApiKeyRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyApiKeyRequestBody request) {
        ...
        @Override
        public VerifyApiKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyApiKeyResponse.Builder resBuilder =
            ...
            VerifyApiKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<VerifyApiKeyResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.VerifyApiKeyResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw VerifyAPIKeyAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
