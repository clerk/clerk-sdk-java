...
public class GetSAMLConnection {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetSAMLConnectionRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSAMLConnectionRequest, GetSAMLConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetSAMLConnectionRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSAMLConnectionRequest request) throws Exception {
        ...
        @Override
        public GetSAMLConnectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSAMLConnectionResponse.Builder resBuilder =
            ...
            GetSAMLConnectionResponse res = resBuilder.build();
