...
public class GetOrganizationInvitationOperation implements RequestOperation<GetOrganizationInvitationRequest, GetOrganizationInvitationResponse> {
    ...
    public GetOrganizationInvitationOperation(
    ...
    public HttpRequest buildRequest(GetOrganizationInvitationRequest request) throws Exception {
