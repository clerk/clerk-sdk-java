...
public class GetRedirectURL {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetRedirectURLRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRedirectURLRequest, GetRedirectURLResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetRedirectURLRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRedirectURLRequest request) throws Exception {
        ...
        @Override
        public GetRedirectURLResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRedirectURLResponse.Builder resBuilder =
            ...
            GetRedirectURLResponse res = resBuilder.build();
