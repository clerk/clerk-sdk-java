...
public class RevokeInvitationOperation implements RequestOperation<RevokeInvitationRequest, RevokeInvitationResponse> {
    ...
    public RevokeInvitationOperation(
    ...
    public HttpRequest buildRequest(RevokeInvitationRequest request) throws Exception {
