...
import com.clerk.backend_api.models.operations.RevokeApiKeyResponseBody;
...
public class RevokeApiKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeApiKeyRequest, RevokeApiKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeApiKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeApiKeyRequest.class, new TypeReference<RevokeApiKeyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeApiKeyRequest request) {
        ...
        @Override
        public RevokeApiKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeApiKeyResponse.Builder resBuilder =
            ...
            RevokeApiKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<RevokeApiKeyResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.RevokeApiKeyResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw RevokeAPIKeyAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
