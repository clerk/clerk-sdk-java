...
public class CreateActorToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends CreateActorTokenRequestBody>, CreateActorTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(Optional<? extends CreateActorTokenRequestBody> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends CreateActorTokenRequestBody>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateActorTokenRequestBody> request) throws Exception {
        ...
        @Override
        public CreateActorTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateActorTokenResponse.Builder resBuilder =
            ...
            CreateActorTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ActorToken out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withActorToken(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
