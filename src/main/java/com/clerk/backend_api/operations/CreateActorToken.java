...
public class CreateActorToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends CreateActorTokenRequestBody> request) {
        ...
        @Override
        public CreateActorTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActorToken(Utils.unmarshal(response, new TypeReference<ActorToken>() {}));
                } else {
