...
public class RejectWaitlistEntry {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(RejectWaitlistEntryRequest request) throws Exception {
            String url = Utils.generateURL(
                    RejectWaitlistEntryRequest.class,
                    this.baseUrl,
    ...
    public static class Sync extends Base
            implements RequestOperation<RejectWaitlistEntryRequest, RejectWaitlistEntryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RejectWaitlistEntryRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RejectWaitlistEntryRequest request) throws Exception {
        ...
        @Override
        public RejectWaitlistEntryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RejectWaitlistEntryResponse.Builder resBuilder =
            ...
            RejectWaitlistEntryResponse res = resBuilder.build();
