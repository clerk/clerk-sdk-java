...
public class ListDirectories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDirectoriesRequest, ListDirectoriesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDirectoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDirectoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDirectoriesRequest request) {
        ...
        @Override
        public ListDirectoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDirectoriesResponse.Builder resBuilder =
            ...
            ListDirectoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDirectoryList(Utils.unmarshal(response, new TypeReference<DirectoryList>() {}));
                } else {
