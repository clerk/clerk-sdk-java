...
public class UpdateOrganizationMembershipOperation implements RequestOperation<UpdateOrganizationMembershipRequest, UpdateOrganizationMembershipResponse> {
    ...
    public UpdateOrganizationMembershipOperation(
    ...
    public HttpRequest buildRequest(UpdateOrganizationMembershipRequest request) throws Exception {
