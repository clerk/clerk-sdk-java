...
public class UserPasskeyDeleteOperation implements RequestOperation<UserPasskeyDeleteRequest, UserPasskeyDeleteResponse> {
    ...
    public UserPasskeyDeleteOperation(
    ...
    public HttpRequest buildRequest(UserPasskeyDeleteRequest request) throws Exception {
