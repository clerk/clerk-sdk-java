...
public class CreateOrganizationDomainOperation implements RequestOperation<CreateOrganizationDomainRequest, CreateOrganizationDomainResponse> {
    ...
    public CreateOrganizationDomainOperation(
    ...
    public HttpRequest buildRequest(CreateOrganizationDomainRequest request) throws Exception {
