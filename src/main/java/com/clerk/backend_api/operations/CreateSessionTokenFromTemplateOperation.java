...
public class CreateSessionTokenFromTemplateOperation implements RequestOperation<CreateSessionTokenFromTemplateRequest, CreateSessionTokenFromTemplateResponse> {
    ...
    public CreateSessionTokenFromTemplateOperation(
    ...
    public HttpRequest buildRequest(CreateSessionTokenFromTemplateRequest request) throws Exception {
