...
public class UpdateUserMetadata {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUserMetadataRequest request) {
        ...
        @Override
        public UpdateUserMetadataResponse handleResponse(HttpResponse<InputStream> response) {
