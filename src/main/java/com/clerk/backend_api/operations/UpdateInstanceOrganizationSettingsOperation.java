...
public class UpdateInstanceOrganizationSettingsOperation implements RequestOperation<Optional<? extends UpdateInstanceOrganizationSettingsRequestBody>, UpdateInstanceOrganizationSettingsResponse> {
    ...
    public UpdateInstanceOrganizationSettingsOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends UpdateInstanceOrganizationSettingsRequestBody> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends UpdateInstanceOrganizationSettingsRequestBody> request) throws Exception {
    ...
    @Override
    public UpdateInstanceOrganizationSettingsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UpdateInstanceOrganizationSettingsResponse.Builder resBuilder = 
        ...
        UpdateInstanceOrganizationSettingsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                OrganizationSettings out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withOrganizationSettings(out);
                return res;
            } else {
                throw new SDKError(
                    response, 
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "404", "422")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
