...
public class ReplaceSCIMGroupRoleMappings {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplaceSCIMGroupRoleMappingsRequest, ReplaceSCIMGroupRoleMappingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReplaceSCIMGroupRoleMappingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplaceSCIMGroupRoleMappingsRequest.class, new TypeReference<ReplaceSCIMGroupRoleMappingsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplaceSCIMGroupRoleMappingsRequest request) {
        ...
        @Override
        public ReplaceSCIMGroupRoleMappingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplaceSCIMGroupRoleMappingsResponse.Builder resBuilder =
            ...
            ReplaceSCIMGroupRoleMappingsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSCIMGroupRoleMappingList(Utils.unmarshal(response, new TypeReference<SCIMGroupRoleMappingList>() {}));
                } else {
