...
public class GetUsersCountOperation implements RequestOperation<GetUsersCountRequest, GetUsersCountResponse> {
    ...
    public HttpRequest buildRequest(GetUsersCountRequest request) throws Exception {
