...
public class UpdateEmailAddress {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateEmailAddressRequest, UpdateEmailAddressResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateEmailAddressRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "409", "4XX", "5XX")) {
        ...
        @Override
        public UpdateEmailAddressResponse handleResponse(HttpResponse<InputStream> response) {
