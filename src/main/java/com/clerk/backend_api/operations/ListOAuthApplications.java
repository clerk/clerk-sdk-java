...
public class ListOAuthApplications {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListOAuthApplicationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOAuthApplicationsRequest, ListOAuthApplicationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListOAuthApplicationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOAuthApplicationsRequest request) throws Exception {
        ...
        @Override
        public ListOAuthApplicationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOAuthApplicationsResponse.Builder resBuilder =
            ...
            ListOAuthApplicationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OAuthApplications out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOAuthApplications(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
