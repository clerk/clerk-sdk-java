...
public class ListOAuthApplications {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOAuthApplicationsRequest request) {
        ...
        @Override
        public ListOAuthApplicationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOAuthApplications(Utils.unmarshal(response, new TypeReference<OAuthApplications>() {}));
                } else {
