...
import com.clerk.backend_api.models.operations.GetApiKeysResponseBody;
...
public class GetApiKeys {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetApiKeysRequest, GetApiKeysResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetApiKeysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetApiKeysRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetApiKeysRequest request) {
        ...
        @Override
        public GetApiKeysResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetApiKeysResponse.Builder resBuilder =
                    GetApiKeysResponse
                            .builder()
            ...
            GetApiKeysResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetApiKeysResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.GetApiKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw GetAPIKeysAPIKeysResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
