...
public class ExtendCommerceSubscriptionItemFreeTrial {
    ...
    public static class Sync extends Base
            implements RequestOperation<ExtendCommerceSubscriptionItemFreeTrialRequest, ExtendCommerceSubscriptionItemFreeTrialResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ExtendCommerceSubscriptionItemFreeTrialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ExtendCommerceSubscriptionItemFreeTrialRequest.class, new TypeReference<ExtendCommerceSubscriptionItemFreeTrialRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExtendCommerceSubscriptionItemFreeTrialRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public ExtendCommerceSubscriptionItemFreeTrialResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ExtendCommerceSubscriptionItemFreeTrialResponse.Builder resBuilder =
                    ExtendCommerceSubscriptionItemFreeTrialResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ExtendCommerceSubscriptionItemFreeTrialResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceSubscriptionItem out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceSubscriptionItem(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
