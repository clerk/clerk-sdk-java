...
public class GetInstanceOAuthApplicationSettings {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "GetInstanceOAuthApplicationSettings",
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetInstanceOAuthApplicationSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetInstanceOAuthApplicationSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInstanceOAuthApplicationSettingsResponse.Builder resBuilder =
            ...
            GetInstanceOAuthApplicationSettingsResponse res = resBuilder.build();
