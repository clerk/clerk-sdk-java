...
public class GetInstanceProtect {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetInstanceProtectResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetInstanceProtectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInstanceProtectResponse.Builder resBuilder =
            ...
            GetInstanceProtectResponse res = resBuilder.build();
