...
public class GetOrganization {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetOrganizationRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrganizationRequest, GetOrganizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetOrganizationRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrganizationRequest request) throws Exception {
        ...
        @Override
        public GetOrganizationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrganizationResponse.Builder resBuilder =
            ...
            GetOrganizationResponse res = resBuilder.build();
