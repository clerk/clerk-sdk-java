...
public class ListInstanceOrganizationInvitations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInstanceOrganizationInvitationsRequest request) {
        ...
        @Override
        public ListInstanceOrganizationInvitationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationInvitationsWithPublicOrganizationData(Utils.unmarshal(response, new TypeReference<OrganizationInvitationsWithPublicOrganizationData>() {}));
                } else {
