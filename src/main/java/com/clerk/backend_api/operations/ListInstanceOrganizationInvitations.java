...
public class ListInstanceOrganizationInvitations {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListInstanceOrganizationInvitationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInstanceOrganizationInvitationsRequest, ListInstanceOrganizationInvitationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListInstanceOrganizationInvitationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInstanceOrganizationInvitationsRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "404", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public ListInstanceOrganizationInvitationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInstanceOrganizationInvitationsResponse.Builder resBuilder =
            ...
            ListInstanceOrganizationInvitationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrganizationInvitationsWithPublicOrganizationData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrganizationInvitationsWithPublicOrganizationData(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
