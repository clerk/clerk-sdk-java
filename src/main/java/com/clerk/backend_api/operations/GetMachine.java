...
public class GetMachine {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetMachineRequest request) throws Exception {
            String url = Utils.generateURL(
                    GetMachineRequest.class,
                    this.baseUrl,
                    "/machines/{machine_id}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMachineRequest, GetMachineResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetMachineRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMachineRequest request) throws Exception {
        ...
        @Override
        public GetMachineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMachineResponse.Builder resBuilder =
                    GetMachineResponse
                            .builder()
            ...
            GetMachineResponse res = resBuilder.build();
