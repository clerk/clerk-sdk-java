...
public class GetUserBillingSubscription {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserBillingSubscriptionRequest request) {
        ...
        @Override
        public GetUserBillingSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceSubscription(Utils.unmarshal(response, new TypeReference<CommerceSubscription>() {}));
                } else {
