...
public class GetUserBillingSubscription {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetUserBillingSubscriptionRequest request) throws Exception {
            String url = Utils.generateURL(
                    GetUserBillingSubscriptionRequest.class,
                    this.baseUrl,
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUserBillingSubscriptionRequest, GetUserBillingSubscriptionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetUserBillingSubscriptionRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserBillingSubscriptionRequest request) throws Exception {
        ...
        @Override
        public GetUserBillingSubscriptionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUserBillingSubscriptionResponse.Builder resBuilder =
            ...
            GetUserBillingSubscriptionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceSubscription out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceSubscription(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
