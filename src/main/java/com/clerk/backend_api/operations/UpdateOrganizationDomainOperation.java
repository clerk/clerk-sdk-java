...
public class UpdateOrganizationDomainOperation implements RequestOperation<UpdateOrganizationDomainRequest, UpdateOrganizationDomainResponse> {
    ...
    public UpdateOrganizationDomainOperation(
    ...
    public HttpRequest buildRequest(UpdateOrganizationDomainRequest request) throws Exception {
