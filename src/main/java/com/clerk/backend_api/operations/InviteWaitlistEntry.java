...
public class InviteWaitlistEntry {
    ...
    public static class Sync extends Base
            implements RequestOperation<InviteWaitlistEntryRequest, InviteWaitlistEntryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(InviteWaitlistEntryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InviteWaitlistEntryRequest.class, new TypeReference<InviteWaitlistEntryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InviteWaitlistEntryRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "404", "409", "422", "4XX", "5XX")) {
        ...
        @Override
        public InviteWaitlistEntryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            InviteWaitlistEntryResponse.Builder resBuilder =
            ...
            InviteWaitlistEntryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WaitlistEntry out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWaitlistEntry(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "404", "409", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
