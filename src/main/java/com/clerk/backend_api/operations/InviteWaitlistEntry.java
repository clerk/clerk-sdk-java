...
public class InviteWaitlistEntry {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InviteWaitlistEntryRequest request) {
        ...
        @Override
        public InviteWaitlistEntryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWaitlistEntry(Utils.unmarshal(response, new TypeReference<WaitlistEntry>() {}));
                } else {
