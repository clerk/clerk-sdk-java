...
import com.clerk.backend_api.models.operations.RevokeM2MTokenResponseBody;
...
public class RevokeM2MToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeM2MTokenRequest, RevokeM2MTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevokeM2MTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeM2MTokenRequest.class, new TypeReference<RevokeM2MTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeM2MTokenRequest request) throws Exception {
        ...
        @Override
        public RevokeM2MTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeM2MTokenResponse.Builder resBuilder =
            ...
            RevokeM2MTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RevokeM2MTokenResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.clerk.backend_api.models.errors.RevokeM2MTokenResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RevokeM2MTokenM2mResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
