...
public class UpdateMachine {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMachineRequest, UpdateMachineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMachineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMachineRequest.class, new TypeReference<UpdateMachineRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMachineRequest request) {
        ...
        @Override
        public UpdateMachineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMachineResponse.Builder resBuilder =
            ...
            UpdateMachineResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMachine(Utils.unmarshal(response, new TypeReference<Machine>() {}));
                } else {
