...
public class AdjustUserBillingCreditBalance {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "AdjustUserBillingCreditBalance",
    ...
    public static class Sync extends Base
            implements RequestOperation<AdjustUserBillingCreditBalanceRequest, AdjustUserBillingCreditBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AdjustUserBillingCreditBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AdjustUserBillingCreditBalanceRequest.class, new TypeReference<AdjustUserBillingCreditBalanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AdjustUserBillingCreditBalanceRequest request) {
        ...
        @Override
        public AdjustUserBillingCreditBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AdjustUserBillingCreditBalanceResponse.Builder resBuilder =
            ...
            AdjustUserBillingCreditBalanceResponse res = resBuilder.build();
