...
public class DeleteBlocklistIdentifier {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteBlocklistIdentifierRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBlocklistIdentifierRequest, DeleteBlocklistIdentifierResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeleteBlocklistIdentifierRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBlocklistIdentifierRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "402", "404", "4XX", "5XX")) {
        ...
        @Override
        public DeleteBlocklistIdentifierResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteBlocklistIdentifierResponse.Builder resBuilder =
            ...
            DeleteBlocklistIdentifierResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "402", "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
