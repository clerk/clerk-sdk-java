...
public class UpdateAWSCredential {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAWSCredentialRequest, UpdateAWSCredentialResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UpdateAWSCredentialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAWSCredentialRequest.class, new TypeReference<UpdateAWSCredentialRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAWSCredentialRequest request) throws Exception {
        ...
        @Override
        public UpdateAWSCredentialResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAWSCredentialResponse.Builder resBuilder =
            ...
            UpdateAWSCredentialResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AWSCredential out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAWSCredential(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
