...
public class GetBillingStatementPaymentAttempts {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBillingStatementPaymentAttemptsRequest, GetBillingStatementPaymentAttemptsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBillingStatementPaymentAttemptsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBillingStatementPaymentAttemptsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBillingStatementPaymentAttemptsRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "404", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetBillingStatementPaymentAttemptsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBillingStatementPaymentAttemptsResponse.Builder resBuilder =
            ...
            GetBillingStatementPaymentAttemptsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedBillingPaymentAttemptResponse(Utils.unmarshal(response, new TypeReference<PaginatedBillingPaymentAttemptResponse>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "404", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
