...
public class ListRedirectURLs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRedirectURLsRequest request) {
        ...
        @Override
        public ListRedirectURLsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRedirectURLList(Utils.unmarshal(response, new TypeReference<List<RedirectURL>>() {}));
                } else {
