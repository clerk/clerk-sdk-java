...
public class ListRedirectURLs {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListRedirectURLsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRedirectURLsRequest, ListRedirectURLsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListRedirectURLsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRedirectURLsRequest request) throws Exception {
        ...
        @Override
        public ListRedirectURLsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRedirectURLsResponse.Builder resBuilder =
            ...
            ListRedirectURLsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RedirectURL> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRedirectURLList(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
