...
public class DeleteBackupCode {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DeleteBackupCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBackupCodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBackupCodeRequest request) {
        ...
        @Override
        public DeleteBackupCodeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteBackupCodeResponseBody>() {}));
                } else {
