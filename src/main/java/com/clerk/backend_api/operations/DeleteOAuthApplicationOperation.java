...
public class DeleteOAuthApplicationOperation implements RequestOperation<DeleteOAuthApplicationRequest, DeleteOAuthApplicationResponse> {
    ...
    public DeleteOAuthApplicationOperation(
    ...
    public HttpRequest buildRequest(DeleteOAuthApplicationRequest request) throws Exception {
