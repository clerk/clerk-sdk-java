...
public class CreateTestingToken {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CreateTestingTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public CreateTestingTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTestingToken(Utils.unmarshal(response, new TypeReference<TestingToken>() {}));
                } else {
