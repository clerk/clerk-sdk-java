...
public class AddRolesToRoleSet {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddRolesToRoleSetRequest, AddRolesToRoleSetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddRolesToRoleSetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddRolesToRoleSetRequest.class, new TypeReference<AddRolesToRoleSetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddRolesToRoleSetRequest request) {
        ...
        @Override
        public AddRolesToRoleSetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddRolesToRoleSetResponse.Builder resBuilder =
            ...
            AddRolesToRoleSetResponse res = resBuilder.build();
