...
public class ToggleTemplateDeliveryOperation implements RequestOperation<ToggleTemplateDeliveryRequest, ToggleTemplateDeliveryResponse> {
    ...
    public ToggleTemplateDeliveryOperation(
    ...
    public HttpRequest buildRequest(ToggleTemplateDeliveryRequest request) throws Exception {
