...
public class UpdatePhoneNumber {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePhoneNumberRequest, UpdatePhoneNumberResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UpdatePhoneNumberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePhoneNumberRequest.class, new TypeReference<UpdatePhoneNumberRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePhoneNumberRequest request) throws Exception {
        ...
        @Override
        public UpdatePhoneNumberResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePhoneNumberResponse.Builder resBuilder =
            ...
            UpdatePhoneNumberResponse res = resBuilder.build();
