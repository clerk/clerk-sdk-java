...
public class SetUserProfileImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetUserProfileImageRequest, SetUserProfileImageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(SetUserProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetUserProfileImageRequest.class, new TypeReference<SetUserProfileImageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetUserProfileImageRequest request) throws Exception {
        ...
        @Override
        public SetUserProfileImageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetUserProfileImageResponse.Builder resBuilder =
            ...
            SetUserProfileImageResponse res = resBuilder.build();
