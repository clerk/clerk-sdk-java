...
public class DeleteMachine {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteMachineRequest request) throws Exception {
            String url = Utils.generateURL(
                    DeleteMachineRequest.class,
                    this.baseUrl,
                    "/machines/{machine_id}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMachineRequest, DeleteMachineResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeleteMachineRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMachineRequest request) throws Exception {
        ...
        @Override
        public DeleteMachineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMachineResponse.Builder resBuilder =
            ...
            DeleteMachineResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MachineDeleted out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMachineDeleted(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
