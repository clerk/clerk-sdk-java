...
public class DeleteMachine {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMachineRequest request) {
        ...
        @Override
        public DeleteMachineResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMachineDeleted(Utils.unmarshal(response, new TypeReference<MachineDeleted>() {}));
                } else {
