...
public class ListEnterpriseConnectionTestRuns {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEnterpriseConnectionTestRunsRequest, ListEnterpriseConnectionTestRunsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListEnterpriseConnectionTestRunsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnterpriseConnectionTestRunsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnterpriseConnectionTestRunsRequest request) {
        ...
        @Override
        public ListEnterpriseConnectionTestRunsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEnterpriseConnectionTestRunsResponse.Builder resBuilder =
            ...
            ListEnterpriseConnectionTestRunsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnterpriseConnectionTestRuns(Utils.unmarshal(response, new TypeReference<EnterpriseConnectionTestRuns>() {}));
                } else {
