...
import com.clerk.backend_api.models.errors.RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponse404ResponseBody;
import com.clerk.backend_api.models.errors.RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponseBody;
import com.clerk.backend_api.models.errors.RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponseResponseBody;
...
import com.clerk.backend_api.models.operations.RevokeAdminPortalLinkTokenResponseBody;
...
public class RevokeAdminPortalLinkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeAdminPortalLinkTokenRequest, RevokeAdminPortalLinkTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevokeAdminPortalLinkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeAdminPortalLinkTokenRequest.class, new TypeReference<RevokeAdminPortalLinkTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeAdminPortalLinkTokenRequest request) {
        ...
        @Override
        public RevokeAdminPortalLinkTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeAdminPortalLinkTokenResponse.Builder resBuilder =
            ...
            RevokeAdminPortalLinkTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<RevokeAdminPortalLinkTokenResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.clerk.backend_api.models.errors.RevokeAdminPortalLinkTokenResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "403")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponseResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw RevokeAdminPortalLinkTokenAdminPortalLinkTokensResponse404ResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
