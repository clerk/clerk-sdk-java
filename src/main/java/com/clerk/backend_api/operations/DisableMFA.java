...
public class DisableMFA {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableMFARequest, DisableMFAResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DisableMFARequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableMFARequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableMFARequest request) {
        ...
        @Override
        public DisableMFAResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DisableMFAResponseBody>() {}));
                } else {
