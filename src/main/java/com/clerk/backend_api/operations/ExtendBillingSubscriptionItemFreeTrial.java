...
public class ExtendBillingSubscriptionItemFreeTrial {
    ...
    public static class Sync extends Base
            implements RequestOperation<ExtendBillingSubscriptionItemFreeTrialRequest, ExtendBillingSubscriptionItemFreeTrialResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ExtendBillingSubscriptionItemFreeTrialRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ExtendBillingSubscriptionItemFreeTrialRequest.class, new TypeReference<ExtendBillingSubscriptionItemFreeTrialRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExtendBillingSubscriptionItemFreeTrialRequest request) {
        ...
        @Override
        public ExtendBillingSubscriptionItemFreeTrialResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ExtendBillingSubscriptionItemFreeTrialResponse.Builder resBuilder =
            ...
            ExtendBillingSubscriptionItemFreeTrialResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceSubscriptionItem(Utils.unmarshal(response, new TypeReference<CommerceSubscriptionItem>() {}));
                } else {
