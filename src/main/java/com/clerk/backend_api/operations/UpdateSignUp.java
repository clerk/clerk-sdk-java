...
public class UpdateSignUp {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSignUpRequest, UpdateSignUpResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateSignUpRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSignUpRequest.class, new TypeReference<UpdateSignUpRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSignUpRequest request) {
        ...
        @Override
        public UpdateSignUpResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSignUpResponse.Builder resBuilder =
            ...
            UpdateSignUpResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSignUp(Utils.unmarshal(response, new TypeReference<SignUp>() {}));
                } else {
