...
public class GetUsersCount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetUsersCountRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUsersCountRequest, GetUsersCountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetUsersCountRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUsersCountRequest request) throws Exception {
        ...
        @Override
        public GetUsersCountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUsersCountResponse.Builder resBuilder =
            ...
            GetUsersCountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TotalCount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTotalCount(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
