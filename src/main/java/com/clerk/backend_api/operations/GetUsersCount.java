...
public class GetUsersCount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUsersCountRequest request) {
        ...
        @Override
        public GetUsersCountResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTotalCount(Utils.unmarshal(response, new TypeReference<TotalCount>() {}));
                } else {
