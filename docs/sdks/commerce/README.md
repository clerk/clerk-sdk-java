...
<!-- UsageSnippet language="java" operationID="ExtendCommerceSubscriptionItemFreeTrial" method="post" path="/billing/subscription_items/{subscription_item_id}/extend_free_trial" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws ClerkErrors, ClerkErrors, Exception {
        ...
        ExtendCommerceSubscriptionItemFreeTrialResponse res = sdk.commerce().extendSubscriptionItemFreeTrial()
                .subscriptionItemId("<id>")
